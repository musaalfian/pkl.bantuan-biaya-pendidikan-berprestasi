...
<head>
    ...
    <title>Beasiswa Batang - Masuk</title>
                    ...
                    <form action="<?= route_to('login') ?>" method="POST">
                        ...
                        <?php if ($config->validFields === ['email']) : ?>
                            <div class="mt40">
                                ...
                                <input class="form-control mt-2 <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" placeholder="Masukan nama pengguna / email" type="email" id="username/email" name="login" autofocus />
                        ...
                        <?php else : ?>
                            <div class="mt40">
                                ...
                                <input class="form-control mt-2 <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" placeholder="Masukan nama pengguna / email" type="text" id="username/email" name="login" autofocus />
                        ...
                        <div class="mt-3">
                            ...
                            <div class="input__sandi position-relative mt-2">
                                <input class="form-control <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>" placeholder="<?= lang('Auth.password') ?>" placeholder="Masukan kata sandi" type="password" id="sandi" name="password" />
