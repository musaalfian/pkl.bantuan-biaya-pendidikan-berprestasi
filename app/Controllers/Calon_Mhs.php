...
class Calon_mhs extends BaseController
{
    ...
    public function simpan_tambah_identitas_calon_mhs()
    {
        $user_id = user_id();
        if (!$this->validate([
            ...
            return redirect()->to('calon_mhs/tambah_identitas_calon_mhs')->withInput();
        }
        ...
        return redirect()->to('calon_mhs/tambah_identitas_calon_mhs');
    }
    ...
    public function simpan_tambah_keluarga_calon_mhs($no_induk)
    {
        if (!$this->validate([
            ...
            return redirect()->to('calon_mhs/tambah_keluarga_calon_mhs/' . $no_induk)->withInput();
        }
        // dd($no_induk);
        ...
        return redirect()->to('calon_mhs/tambah_keluarga_calon_mhs/' . $no_induk);
    }
    ...
    public function simpan_tambah_lampiran_calon_mhs($no_induk)
    {
        ...
        if ($kategori_1 == 'hafidz' || $kategori_1 == 'ujian sekolah' || $kategori_1 == 'lainnya') {
            if (!$this->validate([
                ...
                'scan_diterima_pt' => 'uploaded[scan_diterima_pt]|max_size[scan_diterima_pt,2048]|mime_in[scan_diterima_pt,application/pdf]',
        ...
        $scan = [
            ...
            $this->request->getFile('scan_diterima_pt'),
        ...
        // session()->setFlashdata('pesan-tambah-keluarga-calon_mhs', 'Data kondisi keluarga berhasil ditambahkan.');
        return redirect()->to('calon_mhs/tambah_lampiran_calon_mhs/' . $no_induk);
    }
    ...
    public function simpan_edit_calon_mhs($no_induk)
    {
        /*******************    IDENTITAS    ********************/
        $identitas = $this->MIdentitas->find_identitas_user(user_id())->getFirstRow('array');
        ...
        if ($kategori_1 == 'hafidz' || $kategori_1 == 'ujian sekolah' || $kategori_1 == 'lainnya') {
            if (!$this->validate([
                ...
                'scan_diterima_pt' => 'max_size[scan_diterima_pt,2048]|mime_in[scan_diterima_pt,application/pdf]',
        ...
        $nama_file = ['kk', 'ktp', 'kartu_pelajar', 'sktm', 'diterima_pt', 'proposal', 'pas_foto'];
        ...
        $this->MFile->update($file['id_file'], [
            ...
            'kartu_pelajar' => $nama_scan[2],
            'sktm' => $nama_scan[3],
            'diterima_pt' => $nama_scan[4],
            'proposal' => $nama_scan[5],
            'pas_foto' => $nama_scan[6],
        ]);
