...
<div class="bgwhite py40">
    <div class=" admin-content mx-auto">
        <div class="d-flex justify-content-between align-items-end">
            ...
            <a data-bs-toggle="modal" data-bs-target="#ubahStatusPembayaranKeseluruhan"
            ...
            <table class="table py-3 mb-3" id="table_data_pendaftaran">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="" class="fs16 fw-normal" data-bs-toggle="modal"
            ...
            <div class="modal-body">
                ...
                <form
                    ...
                    <div class="form-checks mt-3 mb-3">
                        ...
                        <?php foreach ($status_pembayaran as $status_pembayarans) : ?>
                        <input type="radio" id="statusPembayaran_<?= $status_pembayarans['id_status_pembayaran']; ?>"
                        ...
                        <label class="form-check-label"
                            for="statusPembayaran_<?= $status_pembayarans['id_status_pembayaran']; ?>">
                            <?= $status_pembayarans['nama_status_pembayaran']; ?>
                        </label>
                        <?php endforeach ?>
                    </div>
...
<div class="modal fade" id="ubahNorek_<?= $datas['no_induk']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php base_url() ?>/admin_daftar_penerima/ubah_nomor_rekening/<?= $datas['no_induk'] ?>/2"
                    method="POST">
                    <p class="bold">Nomor Rekening saat ini : <?= $datas['no_rek']; ?></p>
                    <label for="" class="mt-2">Ubah Nomor rekening</label>
                    <input value="<?= $datas['no_rek']; ?>" type="number" class="rounded mt-2 p-2 w-100"
                        name="nomorRekening">
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary">Simpan</button>
...
<div class="modal fade" id="ubahNominal_<?= $datas['no_induk']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php base_url() ?>/admin_daftar_penerima/ubah_nominal/<?= $datas['no_induk'] ?>/2"
                    method="POST">
                    <p class="bold">Nominal Beasiswa Saat Ini : Rp. <?= $datas['nominal']; ?></p>
                    <label for="" class="mt-2">Ubah Nominal Beasiswa</label>
                    <span>
                        Rp.
                        <input type="number" value="<?= $datas['nominal']; ?>" placeholder="Masukkan Nominal Angka"
                            class="d-inline p-2  mt-2 rounded w-100 ml-2" name="nominal">
                    </span>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary">Simpan</button>
