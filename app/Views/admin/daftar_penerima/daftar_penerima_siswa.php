...
<div class="bgwhite py40">
    <div class=" admin-content mx-auto">
        <div class="d-flex justify-content-between align-items-end">
            <h3 class="biru">Data Penerima Beasiswa Peserta Didik</h3>
                ...
                <tbody>
                    ...
                    <?php foreach ($identitas as $data) : ?>
                        <tr>
                            ...
                            <td><a href="" class="fw-normal fs16" data-bs-toggle="modal" data-bs-target="#detail_penerima_<?= $data['no_induk']; ?>">Detail</a></td>
                            <td>
    ...
    <div class="modal fade" id="ubahNominal_<?= $datas['no_induk']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php base_url() ?>/admin_daftar_penerima/ubah_nominal/<?= $datas['no_induk'] ?>/1" method="POST">
