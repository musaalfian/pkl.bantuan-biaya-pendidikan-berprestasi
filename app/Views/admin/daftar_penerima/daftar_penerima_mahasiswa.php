    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php base_url() ?>/Admin_daftar_penerima/ubah_status_pembayaran_keseluruhan/3"
                    method="POST">
...
<div class="modal fade" id="ubahNorek_<?= $datas['no_induk']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php base_url() ?>/Admin_daftar_penerima/ubah_nomor_rekening/<?= $datas['no_induk'] ?>/3"
                    method="POST">
...
<div class="modal fade" id="ubahNominal_<?= $datas['no_induk']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php base_url() ?>/Admin_daftar_penerima/ubah_nominal/<?= $datas['no_induk'] ?>/3"
                    method="POST">
