...
<body>
    ...
    <!-- pembuka -->
    <h5 class="mt-3 text-center">PENDAFTAR PROGRAM BANTUAN BIAYA PENDIDIKAN <br>
        <?php if ($id_status_peserta == 1) {
            echo 'PESERTA DIDIK PENDIDIKAN MENENGAH';
        } elseif ($id_status_peserta == 2) {
            echo 'CALON MAHASISWA';
        ...
        KABUPATEN BATANG TAHUN 2022</h5>
    <h5 class="text-center mt-2">Status : <?= ucfirst($status_pendaftaran['nama_status']); ?></h5>
