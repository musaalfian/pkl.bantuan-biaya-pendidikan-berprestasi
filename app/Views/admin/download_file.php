            ...
            <form action="<?= base_url(); ?>/admin_download/print_download_pendaftaran" method="POST">
                <div class="row mb20">
                    <div class="col-lg-6 col-12">
                        <h4 class="mt-3">File Dwonload</h4>
                        <div class="form-check tahap_pendaftaran">
                            <input class="form-check-input" value="pdf" type="radio" name="file_download" id="pdf"
                                checked>
                        ...
                        <div class="form-check tahap_pendaftaran">
                            <input class="form-check-input" value="pendaftar" type="radio" name="tahap_pendaftaran"
                                id="pendaftar" checked>
                            <label class="form-check-label" for="pendaftar">
                                Pendaftar
                            </label>
                        </div>
                        <div class="form-check tahap_pendaftaran">
                            <input class="form-check-input" value="penerima" type="radio" name="tahap_pendaftaran"
                                id="penerima">
