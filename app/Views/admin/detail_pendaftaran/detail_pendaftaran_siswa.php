...
<div class="bgwhite py40">
    <div class="w90 detail mx-auto">
        <div class="navigasi d-flex flex-wrap align-items-center mb-3">
            <a href="<?= base_url(); ?>/admin_data_pendaftaran/data_pendaftaran_siswa" class="fw-bold blue fs14 me-3"><i
                    class="fa-solid fa-arrow-left-long"></i></a>
            <a href="<?= base_url(); ?>/admin_data_pendaftaran/data_pendaftaran_siswa" class="blue fs14">Data
                Pendaftaran <span class="mx-2 blue fs14">/</span></a>
            <a href="" class="abu fs14">Detail Peserta Didik</a>
        </div>
        <div class="d-flex justify-content-between align-items-end mb-3">
            <h3 class="biru">Detail Pendaftar Bantuan Biaya Pendidikan Peserta Didik</h3>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/file/<?= $detail_pendaftar['raport_smt']; ?>"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/file/<?= $detail_pendaftar['raport_legalisasi']; ?>"
                                        class="btn btn-white mb15 mt-2" target="_blank">Lihat</a>
                                </td>
                                <td>
                                    <div class="input-group">
