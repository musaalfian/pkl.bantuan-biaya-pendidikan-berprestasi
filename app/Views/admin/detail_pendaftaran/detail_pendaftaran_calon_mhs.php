...
<div class="bgwhite py40">
    <div class="w90 content detail mx-auto">
        <div class="navigasi d-flex flex-wrap align-items-center mb-3">
            <a href="<?= base_url(); ?>/admin_data_pendaftaran/data_pendaftaran_calon_mhs" class="fw-bold blue fs14 me-3"><i class="fa-solid fa-arrow-left-long"></i></a>
            <a href="<?= base_url(); ?>/admin_data_pendaftaran/data_pendaftaran_calon_mhs" class="blue fs14">Data Pendaftaran <span class="mx-2 blue fs14">/</span></a>
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><?= $detail_pendaftar['nama_pt']; ?> Km</td>
                                <td>
                                    <div class="input-group">
                                        <input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input">
                                    </div>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/file/<?= $detail_pendaftar['diterima_pt']; ?>" class="btn btn-white mb15 mt-2" target="_blank">Lihat</a>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/file/<?= $detail_pendaftar['proposal']; ?>" class="btn btn-white mb15 mt-2" target="_blank">Lihat</a>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input">
