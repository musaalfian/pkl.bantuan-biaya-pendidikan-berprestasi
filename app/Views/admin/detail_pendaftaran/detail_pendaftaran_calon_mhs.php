                            ...
                            <div class="col-lg-6 c0l-12">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p>Keterangan Diterima Perguruan Tinggi</p>
                                                <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/file/<?= $detail_pendaftar['diterima_pt']; ?>" class="btn btn-white mt15" target="_blank">lihat</a>
                                            </td>
                                            <td>
                                                <div class="input-group mb-3">
                                                    <input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input">
                                        ...
                                        <!-- end Keterangan Diterima Perguruan Tinggi -->
                                        <tr>
                                            <td>
