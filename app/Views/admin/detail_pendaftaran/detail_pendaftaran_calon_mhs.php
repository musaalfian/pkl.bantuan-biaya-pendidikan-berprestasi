...
<div class="bgwhite py40">
    <div class="w90 content detail mx-auto">
        <div class="navigasi d-flex flex-wrap align-items-center mb-3">
            <a href="<?= base_url(); ?>/admin_data_pendaftaran/data_pendaftaran_calon_mhs"
                class="fw-bold blue fs14 me-3"><i class="fa-solid fa-arrow-left-long"></i></a>
            <a href="<?= base_url(); ?>/admin_data_pendaftaran/data_pendaftaran_calon_mhs" class="blue fs14">Data
                Pendaftaran <span class="mx-2 blue fs14">/</span></a>
            <a href="" class="abu fs14">Detail Calon Mahasiswa</a>
        </div>
        <div class="d-flex justify-content-between align-items-end mb-3">
            <h3 class="biru">Detail Pendaftar Bantuan Biaya Pendidikan Calon Mahasiswa</h3>
            <a class="btn btn-primary fw-normal"
        ...
        <div class="bg-white p-4 br1 bdgrey">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="mb-2">
                                ...
                                <div class="d-flex">
                                    <input disabled class="form-control" name="scan_prestasi_<?= $i; ?>"
                                        id="scan_prestasi_<?= $i; ?>" type="text"
                                        value="<?= $prestasi['file_prestasi']; ?>" />
                                    <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/prestasi/<?= $prestasi['file_prestasi']; ?>"
                                        target="_blank" class="btn btn-white ms-3">Lihat</a>
                                </div>
                            </div>
                            <!-- End scan prestasi -->
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <input disabled class="form-control" name="kategori_prestasi_<?= $i; ?>"
                                    id="kategori_prestasi_<?= $i; ?>" type="text"
                            ...
                            <tr class="mt20">
                                <td>
                                    ...
                                    <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/file/<?= $detail_pendaftar['kk']; ?>"
                                        target="_blank" class="btn btn-white mb15 mt-2">Lihat</a>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <input class="form-check-input mt-0" type="checkbox" value=""
                ...
                <div class="col-lg-6 col-12">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <p class="fs16">Keterangan Diterima Perguruan Tinggi</p>
                                    <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/file/<?= $detail_pendaftar['diterima_pt']; ?>"
                                        class="btn btn-white mb15 mt-2" target="_blank">Lihat</a>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <input class="form-check-input mt-0" type="checkbox" value=""
                            ...
                            <tr>
                                <td>
                                    <p class="fs16">Proposal Bantuan</p>
            ...
            <form
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        ...
                        <button type="button" data-bs-toggle="modal" data-bs-target="#save_log"
                            class="btn btn-success fs16 fw-normal mt-3">
            ...
            <!-- perbaikan data log -->
            <form
                action="<?= base_url(); ?>/admin_detail_pendaftaran/simpan_perbaikan_data_benar/<?= $detail_pendaftar['no_induk']; ?>"
                method="post">
