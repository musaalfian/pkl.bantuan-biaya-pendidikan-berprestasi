                ...
                <div class="col-lg-6 col-12">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <p class="fs16">Surat Akreditasi Perguruan Tinggi</p>
                                    <a href="<?= base_url(); ?>/assets/scan/<?= $detail_pendaftar['no_induk']; ?>/file/<?= $detail_pendaftar['akreditasi_pt']; ?>" class="btn btn-white mb15 mt-2" target="_blank">Lihat</a>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input">
