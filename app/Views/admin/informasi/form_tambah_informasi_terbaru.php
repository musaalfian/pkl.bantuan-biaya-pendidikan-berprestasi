    ...
    <div class=" admin-content mx-auto">
        ...
        <form action="<?= base_url(); ?>/admin_informasi/simpan_tambah_informasi_terbaru" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="mb20">
                ...
                <textarea id="deskripsi_informasi_terbaru" cols="30" rows="10" required class="form-control <?= ($validation->hasError('deskripsi_informasi_terbaru')) ? 'is-invalid' : ''; ?>" name="deskripsi_informasi_terbaru"><?= old('deskripsi_informasi_terbaru'); ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="mb20">
                ...
                <input id="file_informasi_terbaru" type="file" class="form-control <?= ($validation->hasError('file_informasi_terbaru')) ? 'is-invalid' : ''; ?>" name="file_informasi_terbaru" value="<?= old('file_informasi_terbaru'); ?>" accept="application/pdf">
                <div class="invalid-feedback">
            ...
            <div class="mb20">
                ...
                <input id="gambar_informasi_terbaru" type="file" class="form-control dropify <?= ($validation->hasError('gambar_informasi_terbaru')) ? 'is-invalid' : ''; ?>" name="gambar_informasi_terbaru" value="<?= old('gambar_informasi_terbaru'); ?>" accept="image/*" data-max-file-size="5M" data-allowed-file-extensions="jpg jpeg png">
                <div class="invalid-feedback">
