...
<div class="bgwhite py40">
    <div class=" admin-content mx-auto">
        ...
        <div class="row justify-content-around">
            <h3 class="col-6 biru pb20">Daftar Informasi Terbaru</h3>
            <div class="col-6 text-end">
                <button class="btn btn-primary mx-3">
                    <a style="text-decoration: none;" class="text-white" href="<?= base_url(); ?>/admin_informasi/tambah_informasi_terbaru">Tambah</a>
                </button>
            </div>
        </div>
            ...
            <table class="table p-4" id="table_data_pendaftaran">
                ...
                <?php foreach ($daftar_informasi as $daftar) : ?>
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#daftar_informasi_terbaru_<?= $daftar['id_informasi_terbaru']; ?>" class="btn btn-primary">Detail</button>
                                <a href="<?= base_url(); ?>/admin_informasi/edit_informasi_terbaru/<?= $daftar['id_informasi_terbaru']; ?>" class="btn"><i class="bi bi-pencil-square"></i></a>
                                <button type="button" data-bs-toggle="modal" data-bs-target="#hapus_informasi_terbaru_<?= $daftar['id_informasi_terbaru']; ?>" class="btn "><i class="bi bi-trash3-fill text-red"></i></button>
                            </div>
                        </td>
                        <?php $i++; ?>
                    </tr>
        ...
        <div class="row mt40">
            <h3 class="col-6 biru pb20">Daftar Informasi Untuk Halaman Awal</h3>
        </div>
        <div class="p-4 br1 bdgrey bg-white mt20 ">
            <table class="table p-4" id="table_data_pendaftaran">
                <thead>
                ...
                <?php foreach ($daftar_informasi_pendaftaran as $data_informasi_pendaftaran) : ?>
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#daftar_informasi_pendaftaran_<?= $data_informasi_pendaftaran['id_informasi_terbaru']; ?>" class="btn btn-primary">Detail</button>
                                <a href="<?= base_url(); ?>/admin_informasi/edit_informasi_terbaru/<?= $data_informasi_pendaftaran['id_informasi_terbaru']; ?>" class="btn"><i class="bi bi-pencil-square"></i></a>
                            </div>
                        </td>
                        <?php $i++; ?>
                    </tr>
