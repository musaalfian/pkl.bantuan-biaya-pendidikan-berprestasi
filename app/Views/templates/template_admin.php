  ...
  <div class="admin d-flex" id="wrapper">
    ...
    <div class="sidebar__admin bg-biru" sty id="sidebar-wrapper">
      ...
      <div class="sidebar__item list-group px-3 mt15">
        <div class="p-2 menu nav_admin_dashboard mb-2" id="">
          <a class="nav_admin_dashboard item__active" href="<?= base_url(); ?>/home_admin/index"><i
              class="bi bi-house-door-fill"></i>Dashboard</a>
        </div>
        <div class="p-2 menu nav_admin_data_pendaftaran mb-2">
          <div class="dropdown nav_admin_data_pendaftaran" id="">
            <a class="dropdown-toggle nav_admin_data_pendaftaran" href="#" role="button" id="" data-bs-toggle="dropdown"
              aria-expanded="false">
        ...
        <div class="p-2 menu nav_admin_data_penerima mb-2">
        ...
        <div class="p-2 menu nav_admin_download mb-2">
          <a class="nav_admin_download" href="<?= base_url(); ?>/admin_download/view_download_file"><i
              class="bi bi-box-arrow-in-down"></i>Download</a>
        </div>
        <div class="p-2 menu nav_admin_informasi_pendaftaran mb-2">
          <a class="nav_admin_informasi_pendaftaran" href="<?= base_url(); ?>/admin_informasi/informasi_pendaftaran"><i
        ...
        <div class="p-2 menu nav_admin_akun_pendaftar mb-2">
          <a class="nav_admin_akun_pendaftar" href="<?= base_url('home_admin/daftarAkun'); ?>"><i
              class="bi bi-person-badge"></i>Daftar Akun</a>
        </div>
    ...
    <div id="page-content-wrapper " class="wrap" style="width: 100%">
      ...
      <footer class="p25 bg-white tengah bottom-0">
        <h3 class="fs14 fw-normal"><i class="fa-solid fa-copyright me-1"></i>2022. Dinas Pendidikan dan
