            ...
            <div class="bg-white br25 p-4 p-sm-5 content">
                ...
                <div class="mt-3">
                    ...
                    <?php if ($identitas['pesan'] != null) : ?>
                        <p class="fs14 fw-bold mb-3">Pesan :</p>
                    ...
                    <?php if ($identitas['id_status_pendaftaran'] == 3) { ?>
                        <?php if ($identitas['id_status_peserta'] == 1) { ?>
                            <a href="<?= base_url(); ?>/siswa/edit_siswa/<?= $identitas['no_induk']; ?>" class="mt20 btn btn-primary fw-normal">Ubah
                                Data</a>
                        <?php } else if ($identitas['id_status_peserta'] == 2) { ?>

                            <a href="<?= base_url(); ?>/calon_mhs/edit_calon_mhs/<?= $identitas['no_induk']; ?>" class="btn btn-primary fw-normal">Ubah
                                Data</a>
                        <?php } else if ($identitas['id_status_peserta'] == 3) { ?>
                            <a href="<?= base_url(); ?>/mahasiswa/edit_mhs/<?= $identitas['no_induk']; ?>" class="btn btn-primary fw-normal">Ubah
                                Data</a>
                        <?php } ?>
                    <?php } ?>
                    <!-- end btn edit data -->
                                    ...
                                    <?php else : ?>
                                        ...
                                        <div class="mt15">
                                            <?php if ($identitas['no_rek'] == null) : ?>
                                                ...
                                                <div class="unduh">
                                                    <a href="<?= base_url(); ?>/assets/informasi/file/instrumen_beasiswa.docx" class="btn btn-primary bold ms-3 mt15">Unduh</a>
                                                </div>
                                                <form action="<?= base_url(); ?>/penerima/simpan_tambah_rekening/<?= $identitas['no_induk']; ?>" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                                    <div class="mt15">
                                                        ...
                                                        <input type="number" name="no_rek" id="no_rek" class="form-control btn btn-white d-flex ms-3" value="<?= old('no_rek'); ?>" required>
                                                    ...
                                                    <div class="mt15">
                                                        ...
                                                        <input type="text" name="nama_pemilik_rekening" id="nama_pemilik_rekening" class="form-control d-flex ms-3" value="<?= old('nama_pemilik_rekening'); ?>" required>
                                                        <div class="invalid-feedback ms-3">
                                                    ...
                                                    <div class="mt15">
                                                        ...
                                                        <div class="mt15">
                                                            <input required type="File" id="rek_bpd" class="form-control btn btn-white ms-3" name="rek_bpd" accept="application/pdf">
                                                            <div class="invalid-feedback ms-3">
