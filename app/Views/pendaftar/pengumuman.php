                ...
                <div class="mt-3">
                    ...
                    <?php if ($identitas['id_status_pendaftaran'] == 3) { ?>
                        <?php if ($identitas['id_status_peserta'] == 1) { ?>
                            <a href="<?= base_url(); ?>/siswa/edit_siswa/<?= $identitas['no_induk']; ?>" class="btn btn-primary fw-normal fs14">Ubah
                                Data</a>
                        <?php } else if ($identitas['id_status_peserta'] == 2) { ?>

                            <a href="<?= base_url(); ?>/calon_mhs/edit_calon_mhs/<?= $identitas['no_induk']; ?>" class="btn btn-primary fw-normal fs14">Ubah
                                Data</a>
                        <?php } else if ($identitas['id_status_peserta'] == 3) { ?>
                            <a href="<?= base_url(); ?>/mahasiswa/edit_mhs/<?= $identitas['no_induk']; ?>" class="btn btn-primary fw-normal fs14">Ubah
                                Data</a>
                        <?php } ?>
                    <?php } ?>
                    <!-- end btn edit data -->
                ...
                <?php if ($identitas['no_rek'] == null) : ?>
                    <div class="mt40 bdblue br10 p-3 p-lg-5 laporan__dana">
                        ...
                        <div class="alert alert-primary mt-3">
                            ...
                            <p>3. Scan rekening tidak lebih dari 2MB dengan format penamaan file : <strong>(no induk)_scan_bpd.pdf</strong></p>
                        </div>
                                ...
                                <div class="mt15">
                                    <?php if ($identitas['no_rek'] == null) : ?>
                                        <div class="d-flex align-items-xl-baseline align-items-start">
                                            <h6 class="text-white fs12 bgblue bd50 d-flex justify-content-center align-items-center mb-0 me-2">1</h6>
                                        ...
                                        <form action="<?= base_url(); ?>/penerima/simpan_tambah_rekening/<?= $identitas['no_induk']; ?>" class="needs-validation" method="POST" enctype="multipart/form-data" novalidate>
                                            <div class="mt-3">
                                                <div class="d-flex align-items-xl-baseline align-items-start">
                                                    <h6 class="text-white fs12 bgblue bd50 d-flex justify-content-center align-items-center mb-0 me-2">2</h6>
                                                    <div class="w-75">
                                            ...
                                            <div class="mt-3">
                                                <div class="d-flex align-items-xl-baseline align-items-start">
                                                    <h6 class="text-white fs12 bgblue bd50 d-flex justify-content-center align-items-center mb-0 me-2">3</h6>
                                                    <div class="w-75">
                                                        <label for="nama_pemilik_rekening" class="form-label fs14">Masukkan nama pemilik rekening <span class="text-red">*</span></label>
                                            ...
                                            <div class="mt-3">
                                                <div class="d-flex align-items-xl-baseline align-items-start">
                                                    <h6 class="text-white fs12 bgblue bd50 d-flex justify-content-center align-items-center mb-0 me-2">4</h6>
                                                    <div class="w-75">
                                                        <label for="rek_bpd" class="form-label fs14">Scan halaman depan buku tabungan BPD Jateng <span class="text-red">*</span></label>
