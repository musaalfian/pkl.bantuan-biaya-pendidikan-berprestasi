...
<div class="bglight2">
    <div class="container p40">
        <div class="navigasi d-flex mb-3 align-items-center">
            <a href="<?= base_url(); ?>/home_pendaftar/index" class="fw-bold blue fs16 me-3"><i class="fa-solid fa-arrow-left-long"></i></a>
