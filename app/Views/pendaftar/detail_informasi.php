        ...
        <div class="row detail__info__section">
            <div class="col-12 col-md-8">
                ...
                <div class="detail__desc mt20">
                    ...
                    <p class="mt10">
                        Edaran dapat diunduh <span><a href="<?php base_url(); ?>/assets/informasi/file/<?= $informasi['file_informasi_terbaru']; ?>">Disini</a></span>
                    </p>
                    ...
                    <?php foreach ($kumpulan_3_informasi as $kumpulan_3_informasi) : ?>
                        <div class="border-bottom pb-2 mt20">
                            <div class="info__section">
                                <a href="<?= base_url(); ?>/home_pendaftar/detail_informasi/<?= $kumpulan_3_informasi['id_informasi_terbaru']; ?>" class="fw-bold blue">
