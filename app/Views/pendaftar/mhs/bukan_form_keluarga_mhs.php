            ...
            <div class="row mb40">
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20">
                        ...
                        <input required <?= ($keluarga != null) ? 'disabled' : ''; ?> type="number" class="form-control <?= ($validation->hasError('usia_ayah')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['usia_ayah'] : old('usia_ayah'); ?>" id="usia_ayah" name="usia_ayah" max="100" />
                        <div class="invalid-feedback">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20">
                        ...
                        <input required <?= ($keluarga != null) ? 'disabled' : ''; ?> type="number" class="form-control <?= ($validation->hasError('usia_ibu')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['usia_ibu'] : old('usia_ibu'); ?>" id="usia_ibu" name="usia_ibu" max="100" />
                        <div class="invalid-feedback">
                    ...
                    <div class="mb20">
                        ...
                        <div class="invalid-feedback">
                            <?= ($validation->getError('pendidikan_ibu') == '') ? 'Bagian pendidikan terakhir ibu  wajib diisi' : str_replace('_', ' ', $validation->getError('pendidikan_ibu')); ?>
                        </div>
                    </div>
                    ...
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            <?php foreach ($opsional as $opsional_rstm) : ?>
                                <input type="radio" class="form-check-input" required name="rtsm_rtm" id="rtsm_rtm" <?= ($keluarga != null) ? 'disabled' : ''; ?> <?php if ($keluarga != null) {
                    ...
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            <?php foreach ($opsional as $opsional_pkh) : ?>
                                <input type="radio" class="form-check-input" name="pkh_kks_kbs" id="pkh_kks_kbs" required <?= ($keluarga != null) ? 'disabled' : ''; ?> <?php if ($keluarga != null) {
                    ...
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            <?php foreach ($opsional as $opsional_bsm) : ?>
                                <input required name="bsm_kip" id="bsm_kip" <?= ($keluarga != null) ? 'disabled' : ''; ?> type="radio" class="form-check-input" <?php if ($keluarga != null) {
