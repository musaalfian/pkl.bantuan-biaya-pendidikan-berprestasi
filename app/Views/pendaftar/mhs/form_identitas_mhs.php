...
<div class="bg-abu p40">
    <div class="container">
        <form action="<?= base_url(); ?>/mahasiswa/simpan_tambah_identitas_mhs" method="post" class="needs-validation"
            novalidate>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20">
                        ...
                        <!-- <select required <?= ($identitas != null) ? 'disabled' : ''; ?>
                            ...
                            <input type="radio" name="jenis_kelamin"  required <?= ($identitas != null) ? 'disabled' : ''; ?> <?php if ($identitas != null) {
                    ...
                    <div class="mb20">
                        ...
                        <div class="invalid-feedback">
                            <?= ($validation->getError('no_induk') == '') ? 'Bagian NIM  wajib diisi' : str_replace('_', ' ', $validation->getError('no_induk')) ?>
                        </div>
                    </div>
                    <!-- end NIM -->
                    <div class="mb20">
                    ...
                    <div class="mb20">
                        ...
                        <!-- <select required id="pernah_menerima_bantuan" <?= ($identitas != null) ? 'disabled' : ''; ?>
                            ...
                            <input required type="radio" name="pernah_menerima_bantuan" <?= ($identitas != null) ? 'disabled' : ''; ?> <?php if ($identitas != null) {
                                        ...
                                        } ?> value="<?= $opsional; ?>"><?= ucfirst($opsional); ?></input> <br>
                            <?php endforeach; ?>
                        </select>
                        <div class="invalid-feedback">
                ...
                <div class="col-12 col-md-6">
                    <div class="alamat mb20">
                        <label for="alamat_rumah" class="form-label">Alamat Rumah <span
                                class="required-label">*</span></label>
                        <small class="red"> *alamat berisi dukuh, rt, rw, desa, dan jalan</small>
                    ...
                    <div class="mb20">
                        ...
                        <input required <?= ($identitas != null) ? 'disabled' : ''; ?> type="text"
                            ...
                            placeholder="" />
                        <div class="invalid-feedback">
                            <?= ($validation->getError('nama_pt') == '') ? 'Bagian nama_pt wajib diisi' : str_replace('_', ' ', $validation->getError('nama_pt')); ?>
                        </div>
                    </div>
                    <!-- end nama_pt -->
                    <div class="mb20">
            ...
            <div class="row pb40">
                <div class="col-12 text-end">
                    ...
                    <a <?= ($identitas != null) ? 'href="' . base_url() . '/mahasiswa/tambah_keluarga_mhs/' .
                            $identitas["no_induk"] . '"' : 'data-bs-toggle="modal" data-bs-target="#selanjutnya_modal"' ?>
                        class="btn btn-primary text-white fs18 px-4
                        py-2">Selanjutnya</a>
                </div>
            </div>
            <!-- end submit -->
