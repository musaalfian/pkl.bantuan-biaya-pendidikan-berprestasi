...
<div class="bg-abu py40">
    <div class="edit__calon container">
        <form action="<?= base_url(); ?>/calon_mhs/simpan_edit_calon_mhs/<?= $identitas['no_induk']; ?>" method="post"
            ...
            <div class="row mb40">
                <div class="col-12 col-md-6">
                    ...
                    <!-- end jenis kelamin -->
                    <div class="mb20 has-validation">
                        <label for="no_induk" class="form-label">NIM <span class="required-label">*</span></label>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <!-- end kecamatan -->
                    <div class="mb20 has-validation">
                        <label for="nama_pt" class="form-label">Nama Perguruan Tinggi <span
                                class="required-label">*</span>
                        </label>
                        <input type="text"
                            class="form-control <?= ($validation->hasError('nama_pt')) ? 'is-invalid' : ''; ?>"
                            value="<?= ($identitas != null) ? $identitas['nama_pt'] : old('nama_pt'); ?>" id="nama_pt"
                            placeholder="" name="nama_pt" />
                        <div class="invalid-feedback">
                            <?= ($validation->getError('nama_pt') == '') ? 'Bagian nama_pt guru wajib diisi' : $validation->getError('nama_pt'); ?>
                        </div>
                    </div>
                    <!-- end nama_pt -->
                    <div class="mb20">
                        <label for="akreditasi_pt" class="form-label">Akrediktasi Perguruan Tinggi <span
                                class="required-label">*</span>
                        </label>
                        <select class="form-select <?= ($validation->hasError('akreditasi_pt')) ? 'is-invalid' : ''; ?>"
                        ...
                        <div class="invalid-feedback">
                            <?= ($validation->getError('akreditasi_pt') == '') ? 'Bagian akreditasi_pt guru wajib diisi' : str_replace('_', ' ', $validation->getError('akreditasi_pt')); ?>
                        </div>
                    </div>
                    <!-- end akreditasi_pt -->
                    <div class="mb20">
                        <label for="tahun_masuk_pt" class="form-label">Tahun Masuk Perguruan Tinggi <span
                                class="required-label">*</span>
                        </label>
                        <input type="number"
                        ...
                        <div class="invalid-feedback">
                            <?= ($validation->getError('tahun_masuk_pt') == '') ? 'Bagian tahun_masuk_pt guru wajib diisi' : str_replace('_', ' ', $validation->getError('tahun_masuk_pt')); ?>
                        </div>
                    </div>
                    <!-- end tahun_masuk_pt -->
                    <div class="mb20">
                        <label for="semester_ke" class="form-label">Semester ke <span class="required-label">*</span>
                        </label>
                        <select class="form-select <?= ($validation->hasError('semester_ke')) ? 'is-invalid' : ''; ?>"
                        ...
                        <div class="invalid-feedback">
                            <?= ($validation->getError('semester_ke') == '') ? 'Bagian semester_ke guru wajib diisi' : str_replace('_', ' ', $validation->getError('semester_ke')); ?>
                        </div>
                    </div>
                    <!-- end semester_ke -->
                    <div class="mb20">
                        <label for="alamat_pt" class="form-label">Alamat Perguruan Tinggi <span
                                class="required-label">*</span>
                        </label>
                        <textarea class="form-control <?= ($validation->hasError('alamat_pt')) ? 'is-invalid' : ''; ?>"
                            name="alamat_pt" id="alamat_pt"
                            rows="1"><?= ($identitas != null) ? $identitas['alamat_pt'] : old('alamat_pt'); ?></textarea>
                        <div class="invalid-feedback">
                            <?= ($validation->getError('alamat_pt') == '') ? 'Bagian alamat_pt guru wajib diisi' : str_replace('_', ' ', $validation->getError('alamat_pt')); ?>
                        </div>
                    </div>
                    <!-- end alamat PT -->
                </div>
            ...
            <div class="row mb40">
                <div class="col-12 col-md-6">
                    ...
                    <!-- end nama ayah -->
                    <div class="mb20">
                        <label for="usia" class="form-label">Usia Ayah / Wali <span
                                class="required-label">*</span></label>
                        <input type="number"
                        ...
                        <div class="invalid-feedback">
                            <?= ($validation->getError('usia_ayah') == '') ? 'Bagian nama guru wajib diisi' : $validation->getError('usia_ayah'); ?>
                        </div>
                    </div>
                    <!-- end usia -->
                    <div class="mb20">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <!-- end nama Ibu / Wali -->
                    <div class="mb20">
                        <label for="usia_ibu" class="form-label">Usia Ibu / Wali <span
                                class="required-label">*</span></label>
                        <input type="number"
                            class="form-control <?= ($validation->hasError('usia_ibu')) ? 'is-invalid' : ''; ?>"
                            value="<?= ($keluarga != null) ? $keluarga['usia_ibu'] : old('usia_ibu'); ?>" id="usia_ibu"
                            name="usia_ibu" placeholder="" />
                        <div class="invalid-feedback">
                            <?= ($validation->getError('usia_ibu') == '') ? 'Bagian nama guru wajib diisi' : $validation->getError('usia_ibu'); ?>
                        </div>
                    </div>
                    <!-- end usia -->
                    <div class="mb20">
            ...
            <div class="row pb40">
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20">
                        ...
                        <input hidden
                            ...
                            name="scan_diterima_pt" type="file" accept="application/pdf" id="diterima_pt" />
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20">
                        ...
                        <div class="invalid-feedback">
                            <?= ($validation->getError('scan_proposal') == '') ? 'Bagian scan_proposal guru wajib diisi dan ukuran file tidak lebih dari 2MB' : $validation->getError('scan_proposal'); ?>
                        </div>
                    </div>
                    <!-- end scan_proposal -->
                </div>
