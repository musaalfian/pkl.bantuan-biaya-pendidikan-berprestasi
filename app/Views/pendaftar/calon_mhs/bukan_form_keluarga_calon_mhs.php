...
<div class="bg-abu py40">
    <div class="container form__calon">
        <form action="<?= base_url(); ?>/calon_mhs/simpan_tambah_keluarga_calon_mhs/<?= $identitas['no_induk']; ?>"
                ...
                <div class="col-12 col-md-6">
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            ...
                            <input name="rtsm_rtm" id="rtsm_rtm" required type="radio" class="form-check-input"
                                ...
                                value="<?= $opsional_rstm; ?>"><label for="rtsm_rtm"
                    ...
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" required name="pkh_kks_kbs" id="pkh_kks_kbs"
                                <?= ($keluarga != null) ? 'disabled' : ''; ?>
                                <?php if ($keluarga != null) {
                                ...
                                value="<?= $opsional_pkh; ?>"><label for="rtsm_rtm"
                ...
                <div class="col-12 col-md-6">
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            ...
                            <input name="bsm_kip" id="bsm_kip" type="radio" class="form-check-input" required
                                <?= ($keluarga != null) ? 'disabled' : ''; ?>
                                <?php if ($keluarga != null) {
                                ...
                                value="<?= $opsional_bsm; ?>"><label for="rtsm_rtm"
