...
<!-- Main section -->
<div class="bg-white py40">
    <div class="container informasi__pendaftaran">
        <h2 class="fs30">Informasi Pendaftaran Beasiswa</h2>
        <div class="persyaratan__section mt20">
            <h3 class="fs20">Persyaratan Penerimaan Bantuan</h3>
            <?php $i = 1;
            ...
            <div class="persyaratan__content d-flex align-items-baseline mt10">
                ...
                <p class="fs14"><?= $persyaratan; ?>.</p>
            </div>
            <?php $i++; ?>
            <?php endforeach ?>
            <div class="persyaratan__content d-flex align-items-baseline mt10">
                <div class="nomor d-flex justify-content-center align-items-center me10"><?= $i; ?></div>
                <p>Informasi selengkapnya dapat diunduh <a
        ...
        <div class="alur__section mt30">
            ...
            <div class="mt10">
                <div class="persyaratan__content d-flex align-items-baseline mt10">
                    ...
                    <p class="fw-bold">Proses Seleksi</p>
                </div>
                <div class="mt5 me2rem daftar__beasiswa__section">
                    <div class="d-flex">
                        <p class="no">1.</p>
            ...
            <div class="mt10">
                <div class="persyaratan__content d-flex align-items-baseline mt10">
                    ...
                    <p class="fw-bold">Pengumuman Penerimaan Bantuan</p>
                </div>
                <div class="mt5 me2rem daftar__beasiswa__section">
                    <div class="d-flex">
                        <p class="no">1.</p>
            ...
            <div class="mt10">
                <div class="persyaratan__content d-flex align-items-baseline mt10">
                    ...
                    <p class="fw-bold">Laporan penggunaan Dana</p>
                </div>
                <div class="mt5 me2rem daftar__beasiswa__section">
                    <div class="d-flex">
                        <p class="no">1.</p>
        ...
        <div class="jadwal__section mt30">
            <h3 class="fs20">Jadwal Kegiatan</h3>
