                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20 has-validation">
                        ...
                        <div class="form-check">
                            ...
                            <input required class="form-check-input" type="radio" name="pernah_menerima_bantuan"
                ...
                <div class="col-12 col-md-6">
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            ...
                            <input name="rtsm_rtm" id="rtsm_rtm_<?= ucfirst($opsional_rstm); ?>" required type="radio"
                                ...
                                value="<?= $opsional_rstm; ?>"><label for="rtsm_rtm_<?= ucfirst($opsional_rstm); ?>"
                    ...
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" required name="pkh_kks_kbs"
                                ...
                                value="<?= $opsional_pkh; ?>"><label for="pkh_kks_kbs_<?= ucfirst($opsional_pkh); ?>"
                    ...
                    <div class="mb20">
                        ...
                        <div class="form-check">
                            ...
                            <input name="bsm_kip" id="bsm_kip_<?= ucfirst($opsional_bsm); ?>" type="radio"
                                ...
                                value="<?= $opsional_bsm; ?>"><label for="bsm_kip_<?= ucfirst($opsional_bsm); ?>"
