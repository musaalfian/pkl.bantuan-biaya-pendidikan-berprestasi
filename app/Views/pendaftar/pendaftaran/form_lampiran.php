...
<form action="<?= base_url(); ?>/siswa/simpan_tambah_lampiran_siswa/<?= $identitas['no_induk']; ?>" method="post"
    ...
    <form action="<?= base_url(); ?>/calon_mhs/simpan_tambah_lampiran_calon_mhs/<?= $identitas['no_induk']; ?>"
        ...
        <form action="<?= base_url(); ?>/mahasiswa/simpan_tambah_lampiran_mhs/<?= $identitas['no_induk']; ?>"
                ...
                <div class="row" <?= ($file == null) ? 'id="prestasi_' . $i . '"' : ''; ?>>
                    ...
                    <div class="col-12 col-md-6 col-xxl-2">
                        <div class="mb20">
                            ...
                            <input value="<?= ($file != null) ? $prestasi[$i - 1]['file_prestasi'] : ''; ?>"
                                ...
                                name="scan_prestasi_<?= $i; ?>" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?>
                    ...
                    <div class="col-12 col-md-6 col-xxl-2">
                        <div class="mb20">
                            ...
                            <input <?= ($file != null) ? 'disabled' : ''; ?> <?= ($i == 1) ? 'required' : ''; ?>
                                type="text" id="nama_prestasi_<?= $i; ?>"
                    ...
                    <div class="col-12 col-md-6 col-xxl-1">
                        <div class="mb20">
                            ...
                            <input <?= ($file != null) ? 'disabled' : ''; ?> <?= ($i == 1) ? 'required' : ''; ?>
                                type="number" id="tahun_prestasi_<?= $i; ?>"
                                ...
                                name="tahun_prestasi_<?= $i; ?>" placeholder="" min="2016" max="2022" />
                            <?php if ($file == null) : ?>
                            <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="mb20">
                        ...
                        <input <?= ($file != null) ? 'disabled value="' . $file['kk'] . '"' : ''; ?> required id="kk"
                    ...
                    <div class="mb20">
                        ...
                        <input <?= ($file != null) ? 'disabled value="' . $file['ktp'] . '"' : ''; ?>
                    ...
                    <div class="mb20">
                        ...
                        <input <?= ($file != null) ? 'disabled value="' . $file['kartu_pelajar'] . '"' : ''; ?> required
                            id="kartu_pelajar"
                            class="form-control scan-lampiran <?= ($validation->hasError('scan_kartu_pelajar')) ? 'is-invalid' : ''; ?>"
                            name="scan_kartu_pelajar" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?>
                            accept="application/pdf " data-allowed-file-extensions="pdf" data-height="100"
                            data-max-file-size="2M" />
                        <?php if ($file == null) : ?>
                    ...
                    <div class="mb20">
                        ...
                        <input type="file" required id="pas_foto"
                            ...
                            name="scan_pas_foto" accept="image/*" data-height="100" data-max-file-size="2M"
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20">
                        ...
                        <input required id="diterima_pt"
                            ...
                            name="scan_diterima_pt" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?>
                            accept="application/pdf" data-allowed-file-extensions="pdf" data-height="100"
                            data-max-file-size="2M" />
                        <?php if ($file == null) : ?>
                    ...
                    <div class="mb20">
                        ...
                        <input required id="akreditasi_pt"
                            ...
                            name="scan_akreditasi_pt" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?>
                            accept="application/pdf" data-allowed-file-extensions="pdf" data-height="100"
                            data-max-file-size="2M" />
                        <?php if ($file == null) : ?>
                    ...
                    <div class="mb20">
                        ...
                        <input <?= ($file != null) ? 'disabled value="' . $file['raport_smt'] . '"' : ''; ?> required
                            id="raport_smt"
                            class="form-control scan-lampiran <?= ($validation->hasError('scan_raport_smt')) ? 'is-invalid' : ''; ?>"
                            name="scan_raport_smt" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?>
                            accept="application/pdf" data-allowed-file-extensions="pdf" data-height="100"
                            data-max-file-size="2M" />
                        <?php if ($file == null) : ?>
                    ...
                    <div class="mb20">
                        ...
                        <input <?= ($file != null) ? 'disabled value="' . $file['raport_legalisasi'] . '"' : ''; ?>
                            required id="raport"
                            class="form-control scan-lampiran <?= ($validation->hasError('scan_raport')) ? 'is-invalid' : ''; ?>"
                            name="scan_raport" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?>
                            accept="application/pdf" data-allowed-file-extensions="pdf" data-height="100"
                            data-max-file-size="2M" />
                        <?php if ($file == null) : ?>
                    ...
                    <div class="mb20">
                        ...
                        <input required id="proposal"
                            ...
                            name="scan_proposal" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?>
                            accept="application/pdf" data-allowed-file-extensions="pdf" data-height="100"
                            data-max-file-size="2M" />
                        <?php if ($file == null) : ?>
                    ...
                    <div class="mb20">
                        ...
                        <input <?= ($file != null) ? 'disabled value="' . $file['sktm'] . '"' : ''; ?> required
                            id="sktm"
                            class="form-control  scan-lampiran <?= ($validation->hasError('scan_sktm')) ? 'is-invalid' : ''; ?>"
                            name="scan_sktm" accept="application/pdf"
                            <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> data-allowed-file-extensions="pdf"
            ...
            <!-- end alert lampiran -->
            <!-- SAVE  Modal -->
            <div class="modal fade" id="save_modal_lampiran" tabindex="-1" aria-labelledby="saveModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="btn_submit_lampiran"
