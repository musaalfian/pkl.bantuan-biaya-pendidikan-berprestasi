...
<div class="bg-abu py40">
    <div class="container">
        <form action="<?= base_url(); ?>/pendaftaran/simpanPendaftaran/<?= $identitas['no_induk']; ?>" method="post"
            ...
            <div class="row mt20 mb40">
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20 has-validation">
                        ...
                        <input disabled type="number" min="0" max="9999999999999999" name="no_induk" required
                    ...
                    <div class="mb20 has-validation">
                        ...
                        <select disabled
                            class="form-select <?= ($validation->hasError('agama')) ? 'is-invalid' : ''; ?>" required
                    ...
                    <div class="mb20">
                        <label for="menerima_bantuan_dari" class="form-label">Jika Ya, Menerima Bantuan
                            Dari</label>
                        <input disabled id="menerima_bantuan_dari" id="menerima_bantuan_dari" type="text" maxlength="16"
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="mb20 has-validation">
                        ...
                        <select disabled
                            class="form-select <?= ($validation->hasError('sekolah')) ? 'is-invalid' : ''; ?>" required
                    ...
                    <div class="mb20 has-validation">
                        ...
                        <select disabled
                            class="form-select <?= ($validation->hasError('kelas')) ? 'is-invalid' : ''; ?>" required
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="saveModalLabel">
                                Yakin ingin mengajukan permohonan bantuan biaya pendidikan?
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            Data yang anda masukkan sudah dipastikan benar. <br><br>
                            <small>Catatan : Jika terdapat kesalahan data dapat segera
                                menghubungi Dinas Pendidikan dan Kebudayaan Kab Batang segera.</small>
                        </div>
