...
<div class="pendaftaran py-5 bgwhite">
    <div class="container">
        <h3 class="mb-3 biru fw-bold">Form Pendaftaran Bantuan Biaya Pendidikan <?= ($id_peserta == 1) ? 'SMA/SMK/MA Sederajat' : (($id_peserta == 2) ? 'Calon Mahasiswa' : 'Mahasiswa'); ?></span>
        </h3>
        <div id="smartwizard" class="">
            ...
            <div class="tab-content bdblue br25 p-4 p-sm-5">
                ...
                <div id="step-1" class="tab-pane p-0" role="tabpanel" aria-labelledby="step-1">
                    <?php if ($id_peserta == 1) : ?>
                        <form action="<?= base_url(); ?>/siswa/simpan_tambah_identitas_siswa/<?= $id_peserta; ?>" method="post" class="needs-validation" novalidate>

                            <!-- end sma -->
                        <?php elseif ($id_peserta == 2) : ?>
                            <form action="<?= base_url(); ?>/calon_mhs/simpan_tambah_identitas_calon_mhs/<?= $id_peserta ?>" method="post" class="needs-validation" novalidate>
                                <!-- end calon mahasiswa -->
                            <?php else : ?>
                                <form action="<?= base_url(); ?>/mahasiswa/simpan_tambah_identitas_mhs/<?= $id_peserta ?>" method="post" class="needs-validation" novalidate>
                                    <h3 class="mb20 biru fw-bold">Form Pendaftaran Beasiswa <span class="orange">Mahasiswa</span>
                                        <!-- end mahasiswa -->
                                    <?php endif; ?>
                                    </h3>
                                    <!-- alert identitas -->
                                    ...
                                    <div class="row mt20 mb40">
                                        ...
                                        <option hidden></option> -->
                                                <div class="form-check kelamin">
                                                    ...
                                                    <input <?= ($identitas != null) ? 'disabled' : ''; ?> required type="radio" class="form-check-input ms-3" name="jenis_kelamin" id="P" <?php if ($identitas != null) {
                                            ...
                                            <div class="mb20">
                                                <label for="ttl" class="form-label bold">Tempat, Tanggal Lahir
                                                    <span class="fs14 lightgrey ms-2"> Contoh : Batang, 19 Agustus 2000</span></label>
                                            ...
                                            <div class="alamat mb20">
                                                <label for="alamat_rumah" class="form-label bold">Alamat Rumah <span class="fs14 ms-2 lightgrey">Contoh : alamat berisi dukuh, rt, rw, desa, dan jalan</span></label>
                                            ...
                                            <!-- end alamat -->
                                            <div class="mb20">
                                                <label for="kecamatan" class="form-label bold">Kecamatan <span class="required-label"></span></label>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <?php if ($id_peserta == 1) : ?>
                                                ...
                                                <div class="mb20">
                                                    <label for="transportasi" class="form-label bold">Transportasi Siswa ke Sekolah
                                                        <span class="required-label"></span></label>
                                                    <select required <?= ($identitas != null) ? 'disabled' : ''; ?> class="form-select <?= ($validation->hasError('transportasi')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="transportasi">
                                                        <option selected hidden></option>
                                                ...
                                                <!-- end transportasi -->
                                                <div class="mb20">
                                                    <label for="sekolah" class="form-label bold">Sekolah <span class="required-label"></span></label>
                                                    <select required <?= ($identitas != null) ? 'disabled' : ''; ?> class="form-select <?= ($validation->hasError('sekolah')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="sekolah">
                                                        <option selected hidden></option>
                                                ...
                                                <div class="mb20">
                                                    ...
                                                    <select required <?= ($identitas != null) ? 'disabled' : ''; ?> class="form-select <?= ($validation->hasError('kelas')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="kelas">
                                                        <option hidden></option>
                                                        <option <?php if ($identitas != null) {
                                            ...
                                            <?php endif; ?>
                                            <div class="mb20 ">
                                                <label for="pernah_menerima_bantuan" class="form-label bold">Apakah Calon Penerima
                                                    Beasiswa Pernah
                                                    Menerima Bantuan?
                                                    <span class="required-label"></span></label>
                                                <!-- radio button -->
                                                <div class="form-check pertanyaan">
                                                    <?php foreach ($opsional as $opsional_menerima_bantuan) : ?>
                                                        <input required class="form-check-input <?= ($opsional_menerima_bantuan == "tidak") ? 'ms-3' : ''; ?>" <?= ($identitas != null) ? 'disabled' : ''; ?> type="radio" name="pernah_menerima_bantuan" id="pernah_menerima_bantuan_<?= $opsional_menerima_bantuan; ?>" <?php if ($identitas != null) {
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="row mb40">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <!-- end pekerjaan ayah -->
                                            <div class="mb20">
                                                <label for="pendidikan_ayah" class="form-label bold">Pendidikan Terakhir Ayah /
                                                    Wali
                                                    <span class="required-label">*</span></label>
                                            ...
                                            <div class="mb20">
                                                ...
                                                <div class="form-check">
                                                    <?php foreach ($opsional as $opsional_rstm) : ?>
                                                        <input name="rtsm_rtm" id="rtsm_rtm_<?= ucfirst($opsional_rstm); ?>" required type="radio" class="form-check-input <?= ($opsional_rstm == 'tidak') ? 'ms-3' : ''; ?>" <?= ($keluarga != null) ? 'disabled' : ''; ?> <?php if ($keluarga != null) {
                                            ...
                                            <div class="mb20">
                                                ...
                                                <div class="form-check">
                                                    <?php foreach ($opsional as $opsional_pkh) : ?>
                                                        <input type="radio" class="form-check-input <?= ($opsional_pkh == 'tidak') ? 'ms-3' : ''; ?>" required name="pkh_kks_kbs" id="pkh_kks_kbs_<?= ucfirst($opsional_pkh); ?>" <?= ($keluarga != null) ? 'disabled' : ''; ?> <?php if ($keluarga != null) {
                                            ...
                                            <div class="mb20">
                                                ...
                                                <div class="form-check">
                                                    <?php foreach ($opsional as $opsional_bsm) : ?>
                                                        <input name="bsm_kip" id="bsm_kip_<?= ucfirst($opsional_bsm); ?>" type="radio" class="form-check-input <?= ($opsional_bsm == 'tidak') ? 'ms-3' : ''; ?>" required <?= ($keluarga != null) ? 'disabled' : ''; ?> <?php if ($keluarga != null) {
                ...
                <div id="step-3" class="tab-pane p-0" role="tabpanel" aria-labelledby="step-3">
                    <?php if ($keluarga != null) : ?>
                        <?php if ($identitas['id_status_peserta'] == 1) : ?>
                            <form action="<?= base_url(); ?>/siswa/simpan_tambah_lampiran_siswa/<?= $identitas['no_induk']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                <!-- end sma -->
                            <?php elseif ($identitas['id_status_peserta'] == 2) : ?>
                                <form action="<?= base_url(); ?>/calon_mhs/simpan_tambah_lampiran_calon_mhs/<?= $identitas['no_induk']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    <!-- end calon mahasiswa -->
                                <?php else : ?>
                                    <form action="<?= base_url(); ?>/mahasiswa/simpan_tambah_lampiran_mhs/<?= $identitas['no_induk']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                        <!-- end mahasiswa -->
                                    <?php endif; ?>
                                    <!-- alert lampiran -->
                                    ...
                                    <div class="alert alert-primary">
                                        ...
                                        <p class="fs14">
                                            2. Semua file di upload dan ukuran file tidak boleh lebih dari <strong>2MB</strong>
                                        </p>
                                        <p class="fs14">
                                        ...
                                        <?php for ($i = 1; $i <= $n; $i++) : ?>
                                            <div class="row" <?= ($file == null) ? 'id="prestasi_' . $i . '"' : ''; ?>>
                                                ...
                                                <div class="col-6 col-xl-2">
                                                    <div class="mb20">
                                                        <label for="scan_prestasi_<?= $i; ?>" class="form-label bold">Scan Prestasi
                                                            <?= ($i == 1) ? '<span class="required-label"></span>' : ''; ?>
                                                        </label>
                                                        <input value="<?= ($file != null) ? $prestasi[$i - 1]['file_prestasi'] : ''; ?>" <?= ($file != null) ? 'disabled' : ''; ?> <?= ($i == 1) ? 'required' : ''; ?> id="file_prestasi_<?= $i; ?>" class="form-control  <?= ($validation->hasError('scan_prestasi_' . $i)) ? 'is-invalid' : ''; ?>" name="scan_prestasi_<?= $i; ?>" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-6 col-xl-2">
                                                    <div class="mb20">
                                                        <label for="nama_prestasi_<?= $i; ?>" class="form-label bold">Nama Prestasi
                                                            <?= ($i == 1) ? '<span class="required-label"></span>' : ''; ?></label>
                                                        <input value="<?= ($file != null) ? $prestasi[$i - 1]['nama_prestasi'] : ''; ?>" <?= ($file != null) ? 'disabled' : ''; ?> <?= ($i == 1) ? 'required' : ''; ?> type="text" id="nama_prestasi_<?= $i; ?>" class="form-control <?= ($validation->hasError('nama_prestasi' . $i)) ? 'is-invalid' : ''; ?>" value="<?= old('nama_prestasi' . $i); ?>" name="nama_prestasi_<?= $i; ?>" placeholder="" />
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-6 col-xl-2">
                                                    <div class="mb20">
                                                        <label for="kategori_<?= $i; ?>" class="form-label bold">Kategori Prestasi
                                                            <?= ($i == 1) ? '<span class="required-label"></span>' : ''; ?></label>
                                                        <select <?= ($file != null) ? 'disabled id="kategori_isi_' . $i . '"' : 'id="kategori_' . $i . '"'; ?> <?= ($i == 1) ? 'required' : ''; ?> class="form-select <?= ($validation->hasError('kategori_' . $i)) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="kategori_<?= $i; ?>" id="kategori_<?= $i; ?>">
                                                ...
                                                <div class="col-6 col-xl-2">
                                                    <div class="mb20">
                                                        <label for="tingkat_<?= $i; ?>" class="form-label bold">Tingkat Prestasi
                                                            <?= ($i == 1) ? '<span class="required-label"></span>' : ''; ?></label>
                                                        <select <?= ($file != null) ? 'disabled id="tingkat_isi_' . $i . '"' : 'id="tingkat_' . $i . '"'; ?> disabled class="form-select <?= ($validation->hasError('tingkat_' . $i)) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="tingkat_<?= $i; ?>" ">
                                                ...
                                                <div class="col-6 col-xl-2">
                                                    <div class="mb20">
                                                        ...
                                                        <select <?= ($file != null) ? 'disabled id="juara_isi_' . $i . '"' : 'id="juara_' . $i . '"'; ?> class="form-select <?= ($validation->hasError('juara_' . $i)) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="juara_<?= $i; ?>">
                                                            <option selected></option>
                                                ...
                                                <div class="col-6 col-xl-1">
                                                    <div class="mb20">
                                                        <label for="tahun_prestasi_<?= $i; ?>" class="form-label bold">Tahun <span class="required-label"></span>
                                                        </label>
                                    ...
                                    <div class="alert alert-primary">
                                        <h6 class="bold">Ketentuan :</h6>
                                        <p class="fs14">
                                            1. Semua formulir wajib diisi dan ukuran file tidak boleh lebih dari <strong>2MB</strong>
                                        </p>
                                        <p class="fs14">
                                            2. Dokumen di upload dengan format file<strong>.pdf</strong>, kecuali "Upload Foto Berwana" menggunakan format file <strong>.jpg/.jpeg/.png</strong>
                                        </p>
                                        <p class="fs14">
                                            3. Untuk "Scan Raport Legalisasi", Raport sudah dilegalisasi oleh Kepala Sekolah
                                        </p>
                                        <p class="fs14">
                                            4. Untuk "Scan Surat Keterangan Tidak Mampu", dokumen berupa : <strong>RTSM/RTM, PKH, KIP, atau Surat desa yatim/piatu</strong>
                                        </p>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <div class="mb20">
                                                <label for="scan_kk" class="form-label bold">Scan Kartu Keluarga (KK) <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_kk<strong>.pdf</strong></span></label>
                                                <input <?= ($file != null) ? 'disabled value="' . $file['kk'] . '"' : ''; ?> required id="kk" class="form-control <?= ($validation->hasError('scan_kk')) ? 'is-invalid' : ''; ?>" name="scan_kk" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                <div class="invalid-feedback">
                                            ...
                                            <!-- end scan KK -->
                                            <div class="mb20">
                                                <label for="scan_ktp" class="form-label bold">Scan Kartu Tanda Penduduk (KTP) <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_ktp<strong>.pdf</strong></span>
                                                </label>
                                                <input <?= ($file != null) ? 'disabled value="' . $file['ktp'] . '"' : ''; ?> required id="ktp" class="form-control <?= ($validation->hasError('scan_ktp')) ? 'is-invalid' : ''; ?>" name="scan_ktp" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                <div class="invalid-feedback">
                                            ...
                                            <?php if ($id_peserta == 1 || $id_peserta == 2) : ?>
                                                <div class="mb20">
                                                    <label for="scan_kartu_pelajar" class="form-label bold">Scan Kartu Pelajar <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_kartu_pelajar<strong>.pdf</strong></span>
                                                    </label>
                                                    <input <?= ($file != null) ? 'disabled value="' . $file['kartu_pelajar'] . '"' : ''; ?> required id="kartu_pelajar" class="form-control <?= ($validation->hasError('scan_kartu_pelajar')) ? 'is-invalid' : ''; ?>" name="scan_kartu_pelajar" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                    <div class="invalid-feedback">
                                            ...
                                            <?php else : ?>
                                                <div class="mb20">
                                                    <label for="scan_kartu_pelajar" class="form-label bold">Scan Kartu Mahasiswa <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_ktm<strong>.pdf</strong></span>
                                                    </label>
                                                    <input required id="kartu_pelajar" class="form-control <?= ($validation->hasError('scan_kartu_pelajar')) ? 'is-invalid' : ''; ?>" <?= ($file != null) ? 'disabled value="' . $file['kartu_pelajar'] . '"' : ''; ?> name="scan_kartu_pelajar" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                    <div class="invalid-feedback">
                                                        <?= ($validation->getError('scan_kartu_pelajar') == '') ? 'Bagian scan kartu pelajar  wajib diisi dan ukuran file tidak boleh lebih dari 2MB' : str_replace('_', ' ', $validation->getError('scan_kartu_pelajar')); ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb20">
                                                <label for="scan_pas_foto" class="form-label bold">Upload Foto Berwarna <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_pas_foto<strong>.jpg/.jpeg/.png</strong></span>
                                                </label>
                                                <input type="file" required id="pas_foto" class="form-control lampiran-foto-pendaftaran <?= ($validation->hasError('scan_pas_foto')) ? 'is-invalid' : ''; ?>" name="scan_pas_foto" accept="image/*" data-max-file-size="2M" <?= ($file != null) ? 'disabled hidden data-default-file="' . base_url() . '/assets/scan/' . $identitas["no_induk"] . '/file/' . $file["pas_foto"] . '"' : ''; ?> data-allowed-file-extensions="jpg jpeg png" data-height="100" />
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <?php if ($id_peserta == 2) : ?>
                                                <div class="mb20">
                                                    <label for="scan_diterima_pt" class="form-label bold">Scan Keterangan Diterima Perguruan Tinggi <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_kk<strong>.pdf</strong></span>
                                                    </label>
                                                    <input required id="diterima_pt" class="form-control <?= ($validation->hasError('scan_diterima_pt')) ? 'is-invalid' : ''; ?>" <?= ($file != null) ? 'disabled value="' . $file['diterima_pt'] . '"' : ''; ?> name="scan_diterima_pt" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                    <div class="invalid-feedback">
                                            ...
                                            <?php elseif ($id_peserta == 3) : ?>
                                                <div class="mb20">
                                                    <label for="scan_akreditasi_pt" class="form-label bold">Scan Surat Akreditasi Perguruan Tinggi <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_kk<strong>.pdf</strong></span>
                                                    </label>

                                                    <input required id="akreditasi_pt" class="form-control <?= ($validation->hasError('scan_akreditasi_pt')) ? 'is-invalid' : ''; ?>" <?= ($file != null) ? 'disabled value="' . $file['akreditasi_pt'] . '"' : ''; ?> name="scan_akreditasi_pt" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                    <div class="invalid-feedback">
                                            ...
                                            <?php if ($id_peserta == 1) : ?>
                                                <div class="mb20">
                                                    <label for="scan_raport_smt" class="form-label bold">Scan Nilai Raport Semester Terakhir <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_raport_smt<strong>.pdf</strong></span>
                                                    </label>

                                                    <input <?= ($file != null) ? 'disabled value="' . $file['raport_smt'] . '"' : ''; ?> required id="raport_smt" class="form-control <?= ($validation->hasError('scan_raport_smt')) ? 'is-invalid' : ''; ?>" name="scan_raport_smt" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="mb20">
                                                    <label for="scan_raport" class="form-label bold">Scan Raport Legalisasi <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_raport_legalisasi<strong>.pdf</strong></span>
                                                    </label>
                                                    <input <?= ($file != null) ? 'disabled value="' . $file['raport_legalisasi'] . '"' : ''; ?> required id="raport" class="form-control <?= ($validation->hasError('scan_raport')) ? 'is-invalid' : ''; ?>" name="scan_raport" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                    <div class="invalid-feedback">
                                            ...
                                            <?php else : ?>
                                                <div class="mb20">
                                                    <label for="scan_proposal" class="form-label bold">Scan Proposal Bantuan <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_proposal<strong>.pdf</strong></span>
                                                    </label>
                                                    <input required id="proposal" class="form-control <?= ($validation->hasError('scan_proposal')) ? 'is-invalid' : ''; ?>" <?= ($file != null) ? 'disabled value="' . $file['proposal'] . '"' : ''; ?> name="scan_proposal" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> accept="application/pdf" />
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="mb20">
                                                <label for="scan_sktm" class="form-label bold">Scan Surat Keterangan Tidak Mampu <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_sktm<strong>.pdf</strong></span>
                                                </label>
                                                <input <?= ($file != null) ? 'disabled value="' . $file['sktm'] . '"' : ''; ?> required id="sktm" class="form-control <?= ($validation->hasError('scan_sktm')) ? 'is-invalid' : ''; ?>" name="scan_sktm" accept="application/pdf" <?= ($file != null) ? 'type="text"' : 'type="file"'; ?> />
                                                <div class="invalid-feedback">
                                    ...
                                    <!-- end alert lampiran -->
                                    <!-- SAVE  Modal -->
                                    <div class="modal fade" id="save_modal_lampiran" tabindex="-1" aria-labelledby="saveModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title bold" id="saveModalLabel">
                ...
                <div id="step-4" class="tab-pane p-0" role="tabpanel" aria-labelledby="step-4">
                    <?php if ($file != null) : ?>
                        <?php if ($identitas['id_status_peserta'] == 1) : ?>
                            <form action="<?= base_url(); ?>/siswa/simpan_formulir_pendaftaran/<?= $identitas['no_induk']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                <!-- end sma -->
                            <?php elseif ($identitas['id_status_peserta'] == 2) : ?>
                                <form action="<?= base_url(); ?>/calon_mhs/simpan_formulir_pendaftaran/<?= $identitas['no_induk']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    <!-- end calon mahasiswa -->
                                <?php else : ?>
                                    <form action="<?= base_url(); ?>/mahasiswa/simpan_formulir_pendaftaran/<?= $identitas['no_induk']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                                        <!-- end mahasiswa -->
                                    <?php endif; ?>
                                    ...
                                    <div class="alert alert-primary">
                                        <h6 class="bold">Ketentuan :</h6>
                                        <p class="fs14">
                                            1. Silahkan download formulir pendaftaran <a class="text-decoration-underline" href="<?= base_url(); ?>/home_pendaftar/download_detail_pendaftar/<?= $identitas['no_induk']; ?>" target="_blank">Disini</a>
                                        </p>
                                        <p class="fs14">
                                            2. Formulir pendaftaran ditandatangani oleh orang tua/wali
                                        </p>
                                        <p class="fs14">
                                            3. Setelah ditandatangani, unggah formulir pendaftaran melalui kolom unggahan dibawah ini <strong>(Format file .pdf dan ukuran file tidak boleh lebih dari 8MB)</strong>
                                        </p>
                                    </div>
                                    ...
                                    <div class="mb20 upload__ulang">
                                        <label for="scan_formulir_pendaftaran" class="form-label bold">Formulir Pendaftaran <span class="fs14 lightgrey ms-2"> Contoh penamaan file : (no induk)_scan_formulir_pendaftaran<strong>.pdf</strong></span></label>
                                        <input required <?= ($file['formulir_pendaftaran'] != null) ? 'disabled' : ''; ?> id="formulir_pendaftaran" class="form-control w-100 <?= ($validation->hasError('scan_formulir_pendaftaran')) ? 'is-invalid' : ''; ?>" value="<?= ($file['formulir_pendaftaran'] != null) ? $file['formulir_pendaftaran'] : old('scan_formulir_pendaftaran'); ?>" name="scan_formulir_pendaftaran" type="<?= ($file['formulir_pendaftaran'] != null) ? 'text' : 'file'; ?>" accept="application/pdf" />
                                        <div class="invalid-feedback">
                ...
                <div id="step-5" class="tab-pane p-0" role="tabpanel" aria-labelledby="step-5">
                    <?php if ($file != null && $file['formulir_pendaftaran']) : ?>
                        <form action="<?= base_url(); ?>/pendaftaran/simpanPendaftaran/<?= $identitas['no_induk']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            ...
                            <div class="row mt20 mb40 review">
                                <div class="col-12 col-md-6">
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="text" class="form-control <?= ($validation->hasError('nama_lengkap')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['nama_lengkap'] : old('nama_lengkap'); ?>" name="nama_lengkap" placeholder="" required />
                                        <div class="invalid-feedback">
                                            <?= ($validation->getError('nama_lengkap') == '') ? 'Bagian nama lengkap  wajib diisi' : str_replace('_', ' ', $validation->getError('nama_lengkap')); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb20 has-validation kelamin">
                                        ...
                                        <select disabled class="form-select <?= ($validation->hasError('jenis_kelamin')) ? 'is-invalid' : ''; ?>" required aria-label="Default select example" name="jenis_kelamin">
                                            <option hidden></option>
                                            <option <?php if ($identitas != null) {
                                                        if ($identitas['jenis_kelamin'] == 'L') {
                                                            echo 'selected';
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="number" min="0" max="9999999999999999" name="no_induk" required class="form-control <?= ($validation->hasError('no_induk')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['no_induk'] : old('no_induk'); ?>" name="no_induk" placeholder="" />
                                        <div class="invalid-feedback">
                                            <?= ($validation->getError('no_induk') == '') ? 'Bagian NIK  wajib diisi' : str_replace('_', ' ', $validation->getError('no_induk')) ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="text" class="form-control <?= ($validation->hasError('ttl')) ? 'is-invalid' : ''; ?>" required value="<?= ($identitas != null) ? $identitas['ttl'] : old('ttl'); ?>" name="ttl" placeholder="" />
                                        <div class="invalid-feedback">
                                            <?= ($validation->getError('ttl') == '') ? 'Bagian tempat, tanggal lahir  wajib diisi' : str_replace('_', ' ', $validation->getError('ttl')) ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <select disabled class="form-select <?= ($validation->hasError('agama')) ? 'is-invalid' : ''; ?>" required aria-label="Default select example" name="agama">
                                            <option selected hidden></option>
                                            <?php foreach ($agama as $agama_review) : ?>
                                                <option <?php if ($identitas != null) {
                                                        ...
                                                        } ?> value="<?= $agama_review['id_agama']; ?>"><?= $agama_review['nama_agama']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <div class="invalid-feedback">
                                            <?= ($validation->getError('agama') == '') ? 'Bagian agama wajib diisi' : str_replace('_', ' ', $validation->getError('agama')) ?>
                                    ...
                                    <?php if ($identitas['id_status_peserta'] == 1) : ?>
                                        <div class="mb20 has-validation">
                                            ...
                                            <input disabled type="number" required class="form-control <?= ($validation->hasError('anak_ke')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['anak_ke'] : old('anak_ke'); ?>" name="anak_ke" min="1" placeholder="" />
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="alamat mb20 has-validation">
                                        ...
                                        <textarea disabled required class="form-control mb-2 <?= ($validation->hasError('alamat_rumah')) ? 'is-invalid' : ''; ?>" name="alamat_rumah" id="alamat_rumah" rows="1"><?= ($identitas != null) ? $identitas['alamat_rumah'] : old('alamat_rumah'); ?></textarea>
                                        <div class="invalid-feedback">
                                            <?= ($validation->getError('alamat_rumah') == '') ? 'Bagian alamat rumah  wajib diisi' : $validation->getError('alamat_rumah'); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <select disabled class="form-select <?= ($validation->hasError('kecamatan')) ? 'is-invalid' : ''; ?>" required aria-label="Default select example" name="kecamatan">
                                            <option value="" selected hidden></option>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="number" min="0" max="999999999999999" required class="form-control <?= ($validation->hasError('no_telepon')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['no_telepon'] : old('no_telepon'); ?>" name="no_telepon" placeholder="" />
                                        <div class="invalid-feedback">
                                            <?= ($validation->getError('no_telepon') == '') ? 'Bagian no telepon  wajib diisi dan kurang dari 15 angka' : str_replace('_', ' ', $validation->getError('no_telepon')) ?>
                                        </div>
                                    </div>
                                    ...
                                    <?php if ($identitas['id_status_peserta'] == 3) : ?>
                                        <div class="mb20">
                                            ...
                                            <input disabled required type="number" maxlength="25" name="no_induk_pelajar" class="form-control <?= ($validation->hasError('no_induk_pelajar')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['no_induk_pelajar'] : old('no_induk_pelajar'); ?>" placeholder="" />
                                            <div class="invalid-feedback">
                                                <?= ($validation->getError('no_induk_pelajar') == '') ? 'Bagian NIM  wajib diisi' : str_replace('_', ' ', $validation->getError('no_induk_pelajar')) ?>
                                            </div>
                                        </div>
                                    ...
                                    <?php else : ?>
                                        <div class="mb20 has-validation">
                                            ...
                                            <input disabled type="text" maxlength="25" required class="form-control <?= ($validation->hasError('no_induk_pelajar')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['no_induk_pelajar'] : old('no_induk_pelajar'); ?>" name="no_induk_pelajar" placeholder="" />
                                            <div class="invalid-feedback">
                                    ...
                                    <?php if ($identitas['id_status_peserta'] == 1) : ?>
                                        <div class="mb20 has-validation">
                                            ...
                                            <input disabled type="number" required class="form-control <?= ($validation->hasError('jarak_sekolah')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['jarak_sekolah'] : old('jarak_sekolah'); ?>" name="jarak_sekolah" min="0" step=".1" placeholder="" />
                                            <div class="invalid-feedback">
                                                <?= ($validation->getError('jarak_sekolah') == '') ? 'Bagian jarak sekolah  wajib diisi' : str_replace('_', ' ', $validation->getError('jarak_rumah')) ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb20 has-validation">
                                            ...
                                            <select disabled class="form-select <?= ($validation->hasError('transportasi')) ? 'is-invalid' : ''; ?>" required aria-label="Default select example" name="transportasi">
                                                <option selected hidden></option>
                                        ...
                                        <div class="mb20 has-validation">
                                            ...
                                            <select disabled class="form-select <?= ($validation->hasError('sekolah')) ? 'is-invalid' : ''; ?>" required aria-label="Default select example" name="sekolah">
                                                <option selected hidden></option>
                                        ...
                                        <div class="mb20 has-validation">
                                            ...
                                            <select disabled class="form-select <?= ($validation->hasError('kelas')) ? 'is-invalid' : ''; ?>" required aria-label="Default select example" name="kelas">
                                                <option hidden></option>
                                                <option <?php if ($identitas != null) {
                                                            if ($identitas['kelas'] == '10') {
                                                                echo 'selected';
                                    ...
                                    <?php else : ?>
                                        <div class="mb20 has-validation">
                                            ...
                                            <input disabled type="text" class="form-control <?= ($validation->hasError('nama_pt')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['nama_pt'] : old('nama_pt'); ?>" id="nama_pt" placeholder="" name="nama_pt" />
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="mb20">
                                            ...
                                            <select disabled class="form-select <?= ($validation->hasError('akreditasi_pt')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="akreditasi_pt">
                                                <option selected hidden></option>
                                        ...
                                        <div class="mb20">
                                            ...
                                            <input disabled type="number" class="form-control <?= ($validation->hasError('tahun_masuk_pt')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['tahun_masuk_pt'] : old('tahun_masuk_pt'); ?>" name="tahun_masuk_pt" placeholder="" min="2010" max="2022" />
                                            <div class="invalid-feedback">
                                                <?= ($validation->getError('tahun_masuk_pt') == '') ? 'Bagian tahun masuk perguruan tinggiwajib diisi' : str_replace('_', ' ', $validation->getError('tahun_masuk_pt')); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb20">
                                            ...
                                            <select disabled class="form-select <?= ($validation->hasError('semester_ke')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="semester_ke">
                                                <option selected hidden></option>
                                        ...
                                        <div class="mb20">
                                            ...
                                            <textarea disabled class="form-control <?= ($validation->hasError('alamat_pt')) ? 'is-invalid' : ''; ?>" name="alamat_pt" id="alamat_pt" rows="1"><?= ($identitas != null) ? $identitas['alamat_pt'] : old('alamat_pt'); ?></textarea>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb20">
                                        ...
                                        <select disabled id="pernah_menerima_bantuan" class="form-select <?= ($validation->hasError('pernah_menerima_bantuan')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="pernah_menerima_bantuan">
                                            <option selected hidden></option>
                                    ...
                                    <div class="mb20">
                                        <label for="menerima_bantuan_dari" class="form-label">Jika Ya, Menerima Bantuan
                                            Dari</label>
                                        <input disabled id="menerima_bantuan_dari" id="menerima_bantuan_dari" type="text" maxlength="16" class="form-control <?= ($validation->hasError('menerima_bantuan_dari')) ? 'is-invalid' : ''; ?>" value="<?= ($identitas != null) ? $identitas['menerima_bantuan_dari'] : old('menerima_bantuan_dari'); ?>" name="menerima_bantuan_dari" placeholder="" />
                                        <div class="invalid-feedback">
                                            <?= ($validation->getError('menerima_bantuan_dari') == '') ? '' : str_replace('_', ' ', $validation->getError('menerima_bantuan_dari')) ?>
                                        </div>
                                    </div>
                            ...
                            <div class="row mb40">
                                <div class="col-12 col-md-6">
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="text" required class="form-control <?= ($validation->hasError('nama_ayah')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['nama_ayah'] : old('nama_ayah'); ?>" name="nama_ayah" placeholder="" />
                                        <div class="invalid-feedback">
                                    ...
                                    <?php if ($identitas['id_status_peserta'] != 1) : ?>
                                        <div class="mb20">
                                            ...
                                            <input disabled type="number" class="form-control <?= ($validation->hasError('usia_ayah')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['usia_ayah'] : old('usia_ayah'); ?>" id="usia_ayah" name="usia_ayah" placeholder="" />
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="text" required class="form-control <?= ($validation->hasError('pekerjaan_ayah')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['pekerjaan_ayah'] : old('pekerjaan_ayah'); ?>" name="pekerjaan_ayah" placeholder="" />
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <select disabled required class="form-select <?= ($validation->hasError('pendidikan_ayah')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="pendidikan_ayah">
                                            <option selected hidden></option>
                                            <?php foreach ($pendidikan as $pendidikan_ayah) : ?>
                                                <option <?php if ($keluarga != null) {
                                                            if ($keluarga['pendidikan_ayah'] == $pendidikan_ayah) {
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="number" required class="form-control <?= ($validation->hasError('penghasilan_ayah')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['penghasilan_ayah'] : old('penghasilan_ayah'); ?>" name="penghasilan_ayah" placeholder="" />
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <textarea disabled required class="form-control <?= ($validation->hasError('alamat_ayah')) ? 'is-invalid' : ''; ?>" name="alamat_ayah" name="alamat_ayah" rows="5"><?= ($keluarga != null) ? $keluarga['alamat_ayah'] : old('alamat_ayah'); ?></textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="text" required class="form-control <?= ($validation->hasError('nama_ibu')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['nama_ibu'] : old('nama_ibu'); ?>" name="nama_ibu" placeholder="" />
                                        <div class="invalid-feedback">
                                    ...
                                    <?php if ($identitas['id_status_peserta'] != 1) : ?>
                                        <div class="mb20">
                                            ...
                                            <input disabled type="number" class="form-control <?= ($validation->hasError('usia_ibu')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['usia_ibu'] : old('usia_ibu'); ?>" id="usia_ibu" name="usia_ibu" placeholder="" />
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="text" required class="form-control <?= ($validation->hasError('pekerjaan_ibu')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['pekerjaan_ibu'] : old('pekerjaan_ibu'); ?>" name="pekerjaan_ibu" placeholder="" />
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <select disabled required class="form-select <?= ($validation->hasError('pendidikan_ibu')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="pendidikan_ibu">
                                            <option selected hidden></option>
                                            <?php foreach ($pendidikan as $pendidikan_ibu) : ?>
                                                <option <?php if ($keluarga != null) {
                                                            if ($keluarga['pendidikan_ibu'] == $pendidikan_ibu) {
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <input disabled type="number" required class="form-control <?= ($validation->hasError('penghasilan_ibu')) ? 'is-invalid' : ''; ?>" value="<?= ($keluarga != null) ? $keluarga['penghasilan_ibu'] : old('penghasilan_ibu'); ?>" name="penghasilan_ibu" placeholder="" />
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb20 has-validation">
                                        ...
                                        <textarea disabled class="form-control <?= ($validation->hasError('alamat_ibu')) ? 'is-invalid' : ''; ?>" required name="alamat_ibu" id="alamat_ibu" rows="5"><?= ($keluarga != null) ? $keluarga['alamat_ibu'] : old('alamat_ibu'); ?></textarea>
                                        <div class="invalid-feedback">
                            ...
                            <div class="row mb40">
                                <div class="col-12 col-md-6">
                                    <div class="mb20">
                                        <label for="rtsm_rtm" class="form-label">Rumah Tangga Sangat Miskin (RTSM) / Rumah Tangga Miskin
                                            (RTM)? </label>
                                        <select disabled class="form-select <?= ($validation->hasError('rtsm_rtm')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="rtsm_rtm">
                                            <option selected hidden></option>
                                            <?php foreach ($opsional as $opsional_rstm) : ?>
                                                <option <?php if ($keluarga != null) {
                                                            if ($keluarga['rtsm_rtm'] == $opsional_rstm) {
                                    ...
                                    <div class="mb20">
                                        ...
                                        <select disabled class="form-select <?= ($validation->hasError('pkh_kks_kbs')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="pkh_kks_kbs">
                                            <option selected hidden></option>
                                            <?php foreach ($opsional as $opsional_pkh) : ?>
                                                <option <?php if ($keluarga != null) {
                                                            if ($keluarga['pkh_kks_kbs'] == $opsional_pkh) {
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="mb20">
                                        ...
                                        <select disabled class="form-select <?= ($validation->hasError('bsm_kip')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="bsm_kip">
                                            <option selected hidden></option>
                                            <?php foreach ($opsional as $opsional_bsm) : ?>
                                                <option <?php if ($keluarga != null) {
                                                            if ($keluarga['bsm_kip'] == $opsional_bsm) {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-md-2">
                                            <div class="mb20">
                                                ...
                                                <input disabled class="form-control  <?= ($validation->hasError('scan_prestasi_' . $i)) ? 'is-invalid' : ''; ?>" name="scan_prestasi_<?= $i; ?>" id="file_prestasi_<?= $i; ?>" type="text" accept="application/pdf" value="<?= $prestasi[$i - 1]['file_prestasi']; ?>" />
                                            </div>
                                        </div>
                                        <!-- end file prestasi -->
                                        <div class="col-6 col-md-2">
                                            <div class="mb20">
                                                ...
                                                <input disabled type="text" class="form-control <?= ($validation->hasError('nama_prestasi_' . $i)) ? 'is-invalid' : ''; ?>" value="<?= ($prestasi[$i - 1] != null) ? $prestasi[$i - 1]['nama_prestasi'] : old('nama_prestasi_' . $i); ?>" name="nama_prestasi_<?= $i; ?>" placeholder="" />
                                            </div>
                                        </div>
                                        <!-- end nama prestasi -->
                                        <div class="col-4 col-md-2">
                                            <div class="mb20">
                                                ...
                                                <select disabled class="form-select <?= ($validation->hasError('kategori_' . $i)) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="kategori_<?= $i; ?>" id="kategori_<?= $i; ?>">
                                                    <?php foreach ($kategori as $data_kategori) : ?>
                                                        <option onchange="kategori_prestasi()" <?php
                                                                                                if (old('kategori_' . $i) == $data_kategori) {
                                                                                                    echo 'selected';
                                        ...
                                        <div class="col-3 col-md-2">
                                            <div class="mb20">
                                                ...
                                                <select disabled class="form-select <?= ($validation->hasError('tingkat_' . $i)) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="tingkat_<?= $i; ?>" id="review_tingkat_<?= $i; ?>">
                                                    <option selected></option>
                                                    <?php foreach ($tingkat as $data_tingkat) : ?>
                                                        <option <?= ($prestasi[$i - 1]['tingkat'] == $data_tingkat) ? 'selected' : ''; ?> value="<?= $data_tingkat; ?>">
                                                            <?= $data_tingkat; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-3 col-md-2">
                                            <div class="mb20">
                                                ...
                                                <select disabled class="form-select <?= ($validation->hasError('juara_' . $i)) ? 'is-invalid' : ''; ?>" aria-label="Default select example" id="review_juara_<?= $i; ?>" name="juara_<?= $i; ?>">
                                                    <option selected></option>
                                                    <?php foreach ($juara as $data_juara) : ?>
                                                        <option <?php
                                        ...
                                        <div class="col-2">
                                            <div class="mb20">
                                                ...
                                                <input disabled type="number" class="form-control <?= ($validation->hasError('tahun_prestasi_' . $i)) ? 'is-invalid' : ''; ?>" value="<?= ($prestasi[$i - 1] != null) ? $prestasi[$i - 1]['tahun_prestasi'] : old('tahun_prestasi_' . $i); ?>" name="tahun_prestasi_<?= $i; ?>" placeholder="" min="2010" max="2022" />
                                            </div>
                                        </div>
                                        <!-- end tahun_prestasi -->
                                    </div>
                            ...
                            <div class="row pb40">
                                <div class="col-12 col-md-6">
                                    <div class="mb20">
                                        ...
                                        <input disabled class="form-control custom-file-input   <?= ($validation->hasError('scan_kk')) ? 'is-invalid' : ''; ?>" name="scan_kk" type="text" accept="application/pdf" id="kk" value=" <?= $file['kk']; ?>" />
                                    </div>
                                    <!-- end scan KK -->
                                    <div class="mb20">
                                        <label for="label_scan_ktp" class="form-label">Scan Kartu Tanda Penduduk (KTP)
                                        </label>
                                        <input disabled class="form-control <?= ($validation->hasError('scan_ktp')) ? 'is-invalid' : ''; ?>" name="scan_ktp" type="text" accept="application/pdf" id="ktp" value="<?= $file['ktp']; ?>" />
                                    </div>
                                    <!-- end scan KTP -->
                                    <?php if ($identitas['id_status_peserta'] == 1) : ?>
                                        <div class="mb20">
                                            ...
                                            <input disabled class="form-control <?= ($validation->hasError('scan_kartu_pelajar')) ? 'is-invalid' : ''; ?>" name="scan_kartu_pelajar" type="text" accept="application/pdf" id="kartu_pelajar" value="<?= $file['kartu_pelajar']; ?>" />
                                        </div>
                                        <!-- end scan Kartu pelajar -->
                                    <?php else : ?>
                                        <div class="mb20">
                                            ...
                                            <input disabled class="form-control <?= ($validation->hasError('scan_kartu_pelajar')) ? 'is-invalid' : ''; ?>" name="scan_kartu_pelajar" type="text" value="<?= $file['kartu_pelajar']; ?>" accept="application/pdf" id="kartu_pelajar" />
                                        </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <?php if ($identitas['id_status_peserta'] == 1) : ?>
                                        <div class="mb20">
                                            <label for="label_scan_raport_smt" class="form-label">Scan Nilai Raport Semester Terakhir
                                            </label>
                                            <input disabled class="form-control <?= ($validation->hasError('scan_raport_smt')) ? 'is-invalid' : ''; ?>" name="scan_raport_smt" type="text" value="<?= $file['raport_smt']; ?>" accept="application/pdf" id="raport_smt" />
                                        </div>
                                        <!-- end scan raport smt terakhir -->
                                        <div class="mb20">
                                            <label for="label_scan_raport" class="form-label">Scan Raport Legalisasi
                                            </label>
                                            <input disabled class="form-control <?= ($validation->hasError('scan_raport')) ? 'is-invalid' : ''; ?>" name="scan_raport" type="text" value="<?= $file['raport_legalisasi']; ?>" accept="application/pdf" id="raport" />
                                        </div>
                                        <!-- end scan raport legalisasi -->
                                    <?php endif ?>
                                    <div class="mb20">
                                        ...
                                        <input disabled class="form-control <?= ($validation->hasError('scan_sktm')) ? 'is-invalid' : ''; ?>" name="scan_sktm" accept="application/pdf" type="text" value="<?= $file['sktm']; ?>" id="sktm" />
                                    </div>
                                    <!-- end SKTM -->
                                    <?php if ($identitas['id_status_peserta'] == 2) : ?>
                                        <div class="mb20">
                                            ...
                                            <input disabled class="form-control <?= ($validation->hasError('scan_diterima_pt')) ? 'is-invalid' : ''; ?>" name="scan_diterima_pt" type="text" value="<?= $file['diterima_pt']; ?>" accept="application/pdf" id="diterima_pt" />
                                        </div>
                                        <!-- end scan diterima perguruan tinggi-->
                                    <?php elseif ($identitas['id_status_peserta'] == 3) : ?>
                                        <div class="mb20">
                                            <label for="label_scan_akreditasi_pt" class="form-label">Scan Keterangan Akreditasi Perguruan
                                                Tinggi
                                            </label>
                                            <input disabled class="form-control <?= ($validation->hasError('scan_akreditasi_pt')) ? 'is-invalid' : ''; ?>" name="scan_akreditasi_pt" type="text" value="<?= $file['akreditasi_pt']; ?>" accept="application/pdf" id="akreditasi_pt" />
                                        </div>
                                    ...
                                    <?php if ($identitas['id_status_peserta'] != 1) : ?>
                                        <div class="mb20">
                                            ...
                                            <input disabled class="form-control <?= ($validation->hasError('scan_proposal')) ? 'is-invalid' : ''; ?>" value="<?= $file['proposal']; ?>" name="scan_proposal" type="text" value="<?= $file['proposal']; ?>" accept="application/pdf" id="proposal" />
                                        </div>
                                        <!-- end scan_proposal -->
                                    <?php endif ?>
                                </div>
                            ...
                            <!-- SAVE  Modal -->
                            <div class="modal fade" id="ajukan_modal" tabindex="-1" aria-labelledby="saveModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title bold" id="saveModalLabel">
