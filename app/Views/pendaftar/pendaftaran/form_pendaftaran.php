                        ...
                        <form action="<?= base_url(); ?>/siswa/simpan_tambah_identitas_siswa/<?= $id_peserta; ?>" method="post" class="needs-validation" novalidate>
                            ...
                            <?php elseif ($id_peserta == 2) : ?>
                                <form action="<?= base_url(); ?>/calon_mhs/simpan_tambah_identitas_calon_mhs/<?= $id_peserta ?>" method="post" class="needs-validation" novalidate>
                                    <h3 class="mb20 biru fw-bold">Form Pendaftaran Beasiswa <span class="orange">Calon Mahasiswa</span>
                                        <!-- end calon mahasiswa -->
                                    <?php else : ?>
                                        <form action="<?= base_url(); ?>/mahasiswa/simpan_tambah_identitas_mhs/<?= $id_peserta ?>" method="post" class="needs-validation" novalidate>
                                            ...
                                            <div class="row mt20 mb40">
                                                <div class="col-12 col-md-6">
                                                    <div class="mb20">
                                                        <label for="nama_lengkap" class="form-label">Nama Lengkap <span class="required-label"></span></label>
                                    ...
                                    <option hidden></option> -->
                                                    ...
                                                    <!-- end jenis kelamin -->
                                                    <div class="mb20">
                                                        <label for="no_induk" class="form-label">NIK <span class="required-label"></span></label>
                                                    ...
                                                    <div class="mb20">
                                                        <label for="no_induk_pelajar" class="form-label">NISN <span class="required-label"></span></label>
                                                        ...
                                                        <select required <?= ($identitas != null) ? 'disabled' : ''; ?> class="form-select <?= ($validation->hasError('agama')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" name="agama">
                                                            ...
                                                            <?php foreach ($agama as $agama_pendaftar) : ?>
                                                                <option <?php if ($identitas != null) {
                                                                    ...
                                                                    <?= $agama_pendaftar['nama_agama']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <!-- end anak ke -->
                                                    <div class="mb20">
                                                        <label for="no_telepon" class="form-label">Nomor Telepon <span class="required-label"></span></label>
                                                    ...
                                                    <div class="mb20 ">
                                                        ...
                                                        <div class="form-check">
                                                            <?php foreach ($opsional as $opsional_menerima_bantuan) : ?>
                                                                <input required class="form-check-input" <?= ($identitas != null) ? 'disabled' : ''; ?> type="radio" name="pernah_menerima_bantuan" id="pernah_menerima_bantuan_<?= $opsional_menerima_bantuan; ?>" <?php if ($identitas != null) {
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="row mb40">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="mb20">
                                                <label for="penghasilan_ayah" class="form-label">Penghasilan per Bulan Ayah
                                                    / Wali
                                                    <span class="required-label">*</span></label>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="mb20">
                                                <label for="penghasilan_ibu" class="form-label">Penghasilan per Bulan Ibu /
                                                    Wali
                                                    <span class="required-label">*</span></label>
                        ...
                        <?php if ($identitas['id_status_peserta'] == 1) : ?>
                            ...
                            <?php elseif ($identitas['id_status_peserta'] == 2) : ?>
                                ...
                                <?php else : ?>
                                    ...
                                    <div class="mb20">
                                        ...
                                        <?php for ($i = 1; $i <= $n; $i++) : ?>
                                            <div class="row" <?= ($file == null) ? 'id="prestasi_' . $i . '"' : ''; ?>>
                                                ...
                                                <!-- end tahun_prestasi -->
                                                <div class="col-6 col-sm-1">
                                                    <div class="mb20 text-center" <?= ($file != null) ? 'hidden' : ''; ?>>
                                                        <?php if ($i != 3) : ?>
                                    ...
                                    <p class="bold p20" style="color: red">
                                        Semua formulir wajib diisi dan ukuran file tidak boleh lebih dari 2MB
                                    </p>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="mb20">
                                                <label for="scan_ktp" class="form-label">Scan Kartu Tanda Penduduk (KTP)
                                                    <span style="color: blue; font-size: 12px;">Jika memiliki</span><span style="color: red; font-size: 12px;">Format file .pdf</span></label>
                                                <small style="color: gray">Format nama file :
                                            ...
                                            <div class="mb20">
                                                ...
                                                <input type="file" required id="pas_foto" class="form-control lampiran-foto <?= ($validation->hasError('scan_pas_foto')) ? 'is-invalid' : ''; ?>" name="scan_pas_foto" accept="image/*" data-max-file-size="2M" <?= ($file != null) ? 'disabled hidden data-default-file="' . base_url() . '/assets/scan/' . $identitas["no_induk"] . '/file/' . $file["pas_foto"] . '"' : ''; ?> data-allowed-file-extensions="jpg jpeg png" data-height="100" />
                                                <div class="invalid-feedback">
                ...
                <div class="container">
                    <?php if ($file != null && $file['formulir_pendaftaran']) : ?>
                        <form action="<?= base_url(); ?>/pendaftaran/simpanPendaftaran/<?= $identitas['no_induk']; ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <h2 class="mb40">Review Data Pendaftaran</h2>
                            <!-- Btn Ubah data -->
                            ...
                            <div class="row mt20 mb40">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="alamat mb20 has-validation">
                                        ...
                                        <textarea disabled required class="form-control mb-2 <?= ($validation->hasError('alamat_rumah')) ? 'is-invalid' : ''; ?>" name="alamat_rumah" id="alamat_rumah" rows="4"><?= ($identitas != null) ? $identitas['alamat_rumah'] : old('alamat_rumah'); ?></textarea>
                                        <div class="invalid-feedback">
                                            <?= ($validation->getError('alamat_rumah') == '') ? 'Bagian alamat rumah  wajib diisi' : $validation->getError('alamat_rumah'); ?>
                                        </div>
                                    </div>
                            ...
                            <div class="row pb40">
                                <div class="col-12 col-md-6">
                                    ...
                                    <?php if ($identitas['id_status_peserta'] == 1) : ?>
                                        <div class="mb20">
                                            <label for="label_scan_kartu_pelajar" class="form-label">Scan Kartu Pelajar<span style="color: red; font-size: 12px;">Format file .pdf</span>
                                            </label>
                                    ...
                                    <?php endif ?>
                                    <div class="mb20">
                                        <label for="label_scan_pas_foto" class="form-label">Upload Foto Berwarna<span style="color: red; font-size: 12px;">Format file jpg,jpeg, atau png</span>
                                        </label>
                                        <input disabled hidden class="form-control <?= ($validation->hasError('scan_pas_foto')) ? 'is-invalid' : ''; ?> lampiran-foto" data-allowed-file-extensions="jpg jpeg png " data-height="100" data-max-file-size="2M" name="scan_pas_foto" type="file" accept="image/*" id="pas_foto" data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['pas_foto']; ?>" />
                                    </div>
                                    <!-- end scan_pas_foto -->
                                </div>
                                <div class="col-12 col-md-6">
                                    <?php if ($identitas['id_status_peserta'] == 1) : ?>
                                        <div class="mb20">
                                            <label for="label_scan_raport_smt" class="form-label">Scan Nilai Raport Semester Terakhir <span style="color: red; font-size: 12px;">Format file .pdf</span>
                                            </label>
