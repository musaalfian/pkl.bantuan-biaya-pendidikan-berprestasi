                        ...
                        <?php if ($identitas['id_status_peserta'] == 1) : ?>
                            ...
                            <?php elseif ($identitas['id_status_peserta'] == 2) : ?>
                                ...
                                <?php else : ?>
                                    ...
                                    <?php if ($id_peserta == 2 || $id_peserta == 3) : ?>
                                        <p>Sistematika proposal bantuan biaya pendidikan : <a href="<?= base_url(); ?>/assets/informasi/file/Sistematika Proposal.pdf">Unduh
                                                disini</a> </p>
                                    <?php endif ?>
                                    <div class="alert alert-primary">
                                        <h6 class="bold">Ketentuan :</h6>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-md-2">
                                            <div class="mb20">
                                                ...
                                                <input disabled class="form-control  <?= ($validation->hasError('scan_prestasi_' . $i)) ? 'is-invalid' : ''; ?>" name="scan_prestasi_review<?= $i; ?>" id="file_prestasi_review<?= $i; ?>" type="text" accept="application/pdf" value="<?= $prestasi[$i - 1]['file_prestasi']; ?>" />
                                            </div>
                                        </div>
                                        <!-- end file prestasi -->
                                        <div class="col-6 col-md-2">
                                            <div class="mb20">
                                                ...
                                                <input disabled type="text" class="form-control <?= ($validation->hasError('nama_prestasi_review' . $i)) ? 'is-invalid' : ''; ?>" value="<?= ($prestasi[$i - 1] != null) ? $prestasi[$i - 1]['nama_prestasi'] : old('nama_prestasi_review' . $i); ?>" name="nama_prestasi_review<?= $i; ?>" placeholder="" />
                                            </div>
                                        </div>
                                        <!-- end nama prestasi -->
                                        ...
                                        <div class="col-2">
                                            <div class="mb20">
                                                ...
                                                <input disabled type="number" class="form-control <?= ($validation->hasError('tahun_prestasi_review' . $i)) ? 'is-invalid' : ''; ?>" value="<?= ($prestasi[$i - 1] != null) ? $prestasi[$i - 1]['tahun_prestasi'] : old('tahun_prestasi_review' . $i); ?>" name="tahun_prestasi_review<?= $i; ?>" placeholder="" min="2010" max="2022" />
                                            </div>
                                        </div>
                                        <!-- end tahun_prestasi -->
                                    </div>
