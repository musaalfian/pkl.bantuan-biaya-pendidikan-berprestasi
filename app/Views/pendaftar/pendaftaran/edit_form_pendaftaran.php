...
<div class="bglight2 py40" id="edit__pendaftaran">
    <div class="container">
        ...
        <?php if ($id_peserta == 1) : ?>
        <form action="<?= base_url(); ?>/siswa/simpan_edit_siswa" method="post" enctype="multipart/form-data"
            class="needs-validation" novalidate>
            <!-- end sma -->
            <?php elseif ($id_peserta == 2) : ?>
            <form action="<?= base_url(); ?>/calon_mhs/simpan_edit_calon_mhs" method="post"
                enctype="multipart/form-data" class="needs-validation" novalidate>
                <!-- end calon mahasiswa -->
                <?php else : ?>
                <form action="<?= base_url(); ?>/mahasiswa/simpan_edit_mhs" method="post" enctype="multipart/form-data"
                    class="needs-validation" novalidate>
                    <!-- end mahasiswa -->
                    <?php endif; ?>
                    <div class="tab-content bdblue bgwhite br25 p-4 p-sm-5">
                        ...
                        <div class="row mt20 mb40 ">
                            <div class="col-12 col-md-6">
                                ...
                                <!-- end NIK -->
                                <div class="mb20 ">
                                    <label for="ttl" class="form-label bold">Tempat, Tanggal Lahir <span
                                            class="fs14 lightgrey ms-2"> Contoh : Batang, 19 Agustus
                                            2000</span>
                                    </label>
                                    <input type="text"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="mb20">
                                    <label for="menerima_bantuan_dari" class="form-label bold">Jika Ya, Menerima Bantuan
                                        Dari</label>
                                    <input id="menerima_bantuan_dari" id="menerima_bantuan_dari" type="text"
                                        maxlength="16"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb20">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input name="rtsm_rtm" id="rtsm_rtm_<?= ucfirst($opsional_rstm); ?>" required
                                            type="radio"
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb20">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input name="bsm_kip" id="bsm_kip_<?= ucfirst($opsional_bsm); ?>" type="radio"
                            ...
                            <div class="row" id="edit_prestasi_<?= $i ?>">
                                ...
                                <div class="col-6 col-xxl-2">
                                    <div class="mb20">
                                        ...
                                        <input
                                            class="custom-file-input scan-lampiran <?= ($validation->hasError('scan_prestasi_' . $i)) ? 'is-invalid' : ''; ?>"
                                            <?= ($prestasi[$i - 1] != null) ? 'data-default-file="' . base_url() . '/assets/scan/' . $identitas['no_induk'] . '/file/' . $prestasi[$i - 1]["file_prestasi"] . '"' : ''; ?>
                                            data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                            name="scan_prestasi_<?= $i; ?>" id="file_prestasi_<?= $i; ?>" type="file"
                                            accept="application/pdf" />
                                        <label class=" bg-white" style="cursor: pointer;"
                                ...
                                <div class="col-6 col-xxl-1">
                                    <div class="mb20">
                                        ...
                                        <input <?= ($i == 1) ? 'required' : ''; ?> type="number"
                        ...
                        <div class="row pb40" id="edit_lampiran">
                            <div class="col-12 col-md-6">
                                <div class="mb20">
                                    ...
                                    <input
                                        class="form-control custom-file-input scan-lampiran <?= ($validation->hasError('scan_kk')) ? 'is-invalid' : ''; ?>"
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['kk']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['ktp']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['kartu_pelajar']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-allowed-file-extensions="jpg jpeg png " data-height="200" data-height="100"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['raport_smt']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['raport_legalisasi']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['sktm']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['diterima_pt']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['akreditasi_pt']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                                ...
                                <div class="mb20">
                                    ...
                                    <input
                                        ...
                                        data-default-file="<?= base_url(); ?>/assets/scan/<?= $identitas['no_induk']; ?>/file/<?= $file['proposal']; ?>"
                                        data-allowed-file-extensions="pdf" data-height="100" data-max-file-size="2M"
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <a href="<?= base_url(); ?>/home_pendaftar/pengumuman"
                            class="btn btn-secondary fs16 me-2 fw-normal">Batal</a>
                        <button type="button" data-bs-toggle="modal" data-bs-target="#save_modal"
                            class="btn btn-success fs16 fw-normal">
                            Simpan
                        </button>
                    </div>
                    <!-- end submit -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="btn_submit_edit_pendaftaran"
                ...
                <form action="<?= base_url(); ?>/pendaftaran/simpanEditPendaftaran/<?= $identitas['no_induk']; ?>"
                    ...
                    <div class="tab-content bdblue bgwhite br25 p-4 p-sm-5">
                        ...
                        <div class="alert alert-primary">
                            <h6 class="bold">Ketentuan :</h6>
                            <p class="fs14">
                                1. Download formulir pendaftaran <a class="text-decoration-underline"
                    ...
                    <div class="mt-3 text-end">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#save_formulir_modal"
                            class="btn btn-primary fs16 fw-normal">
                            Simpan
                        </button>
                    </div>
                    <!-- end submit -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="btn_submit_edit_form"
                                        class="btn btn-success fw-normal">Simpan</button>
                                </div>
                            </div>
                        </div>
